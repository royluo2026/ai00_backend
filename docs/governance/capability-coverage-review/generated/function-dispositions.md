...
| Agent | `capability:agent.interaction.cancel` | existing_capability | `agent.interaction.cancel` |
| Agent | `capability:agent.interaction.chat.change.apply` | existing_capability | `agent.interaction.chat.change.apply` |
...
| Agent | `capability:agent.runtime.config.read` | existing_capability | `agent.runtime.config.read` |
| Agent | `capability:agent.script.generate` | existing_capability | `agent.script.generate` |
...
| Craft | `capability:craft.bop.alt_hierarchy.read` | existing_capability | `craft.bop.alt_hierarchy.read` |
| Craft | `rest:GET:/api/bop/versions/{version_gid}/alt-hier` | existing_capability | `craft.bop.alt_hierarchy.read` |
...
| Craft | `capability:craft.bop.entry.bulk.change.apply` | existing_capability | `craft.bop.entry.bulk.change.apply` |
| Craft | `capability:craft.bop.entry.change.apply` | existing_capability | `craft.bop.entry.change.apply` |
| Craft | `capability:craft.bop.entry.detail.get` | existing_capability | `craft.bop.entry.detail.get` |
| Craft | `capability:craft.bop.entry.legacy_read` | existing_capability | `craft.bop.entry.legacy_read` |
| Craft | `rest:GET:/api/bop/entity-detail` | existing_capability | `craft.bop.entry.legacy_read` |
| Craft | `rest:GET:/api/bop/entries/{gid}/history` | existing_capability | `craft.bop.entry.legacy_read` |
| Craft | `rest:GET:/api/bop/entry-links` | existing_capability | `craft.bop.entry.legacy_read` |
| Craft | `rest:GET:/api/bop/pbom/search` | existing_capability | `craft.bop.entry.legacy_read` |
| Craft | `rest:GET:/api/bop/versions/{version_gid}/auto-link-preview` | existing_capability | `craft.bop.entry.legacy_read` |
| Craft | `rest:GET:/api/bop/versions/{version_gid}/history` | existing_capability | `craft.bop.entry.legacy_read` |
...
| Craft | `capability:craft.bop.fork.change.apply` | existing_capability | `craft.bop.fork.change.apply` |
| Craft | `capability:craft.bop.fork_preset.change.apply` | existing_capability | `craft.bop.fork_preset.change.apply` |
| Craft | `rest:DELETE:/api/bop/fork-presets/{gid}` | existing_capability | `craft.bop.fork_preset.change.apply` |
| Craft | `rest:PATCH:/api/bop/fork-presets/{gid}` | existing_capability | `craft.bop.fork_preset.change.apply` |
| Craft | `rest:POST:/api/bop/fork-presets` | existing_capability | `craft.bop.fork_preset.change.apply` |
| Craft | `capability:craft.bop.fork_preset.read` | existing_capability | `craft.bop.fork_preset.read` |
| Craft | `rest:GET:/api/bop/fork-presets` | existing_capability | `craft.bop.fork_preset.read` |
| Craft | `rest:GET:/api/bop/fork-presets/{gid}` | existing_capability | `craft.bop.fork_preset.read` |
| Craft | `capability:craft.bop.gbop.change.apply` | existing_capability | `craft.bop.gbop.change.apply` |
| Craft | `capability:craft.bop.gbop.legacy_read` | existing_capability | `craft.bop.gbop.legacy_read` |
...
| Craft | `capability:craft.bop.lifecycle.change.apply` | existing_capability | `craft.bop.lifecycle.change.apply` |
| Craft | `rest:PATCH:/api/bop/pbom-diff-queue/{item_gid}` | existing_capability | `craft.bop.lifecycle.change.apply` |
| Craft | `rest:PATCH:/api/bop/versions/{gid}/pbom-match` | existing_capability | `craft.bop.lifecycle.change.apply` |
| Craft | `rest:PATCH:/api/bop/versions/{gid}/vehicle-ops-stats` | existing_capability | `craft.bop.lifecycle.change.apply` |
| Craft | `rest:POST:/api/bop/versions/{gid}/pbom-diff-queue` | existing_capability | `craft.bop.lifecycle.change.apply` |
| Craft | `capability:craft.bop.lifecycle.checkpoint.change.apply` | existing_capability | `craft.bop.lifecycle.checkpoint.change.apply` |
| Craft | `capability:craft.bop.lifecycle.checkpoint.rollback.apply` | existing_capability | `craft.bop.lifecycle.checkpoint.rollback.apply` |
| Craft | `capability:craft.bop.lifecycle.history.change.apply` | existing_capability | `craft.bop.lifecycle.history.change.apply` |
| Craft | `capability:craft.bop.lifecycle.read` | existing_capability | `craft.bop.lifecycle.read` |
| Craft | `rest:GET:/api/bop/versions/{gid}/lifecycle/history` | existing_capability | `craft.bop.lifecycle.read` |
| Craft | `rest:GET:/api/bop/versions/{gid}/lifecycle/lines/{line_gid}/checkpoints` | existing_capability | `craft.bop.lifecycle.read` |
| Craft | `rest:GET:/api/bop/versions/{gid}/lifecycle/lines/{line_gid}/history` | existing_capability | `craft.bop.lifecycle.read` |
| Craft | `rest:GET:/api/bop/versions/{gid}/lifecycle/lines/{line_gid}/operation-log` | existing_capability | `craft.bop.lifecycle.read` |
| Craft | `capability:craft.bop.lifecycle.state.change.apply` | existing_capability | `craft.bop.lifecycle.state.change.apply` |
| Craft | `capability:craft.bop.lifecycle.state.read` | existing_capability | `craft.bop.lifecycle.state.read` |
| Craft | `rest:GET:/api/bop/versions/{gid}/lifecycle` | existing_capability | `craft.bop.lifecycle.state.read` |
| Craft | `capability:craft.bop.lifecycle.stats.refresh.apply` | existing_capability | `craft.bop.lifecycle.stats.refresh.apply` |
...
| Craft | `capability:craft.bop.pbom.change_point.get` | existing_capability | `craft.bop.pbom.change_point.get` |
| Craft | `capability:craft.bop.pbom_lifecycle.read` | existing_capability | `craft.bop.pbom_lifecycle.read` |
| Craft | `rest:GET:/api/bop/versions/{gid}/pbom-diff-queue` | existing_capability | `craft.bop.pbom_lifecycle.read` |
| Craft | `rest:GET:/api/bop/versions/{gid}/pbom-link-stats` | existing_capability | `craft.bop.pbom_lifecycle.read` |
| Craft | `capability:craft.bop.picture.upload` | existing_capability | `craft.bop.picture.upload` |
| Craft | `capability:craft.bop.staging.change.apply` | existing_capability | `craft.bop.staging.change.apply` |
| Craft | `capability:craft.bop.staging.lifecycle.change.apply` | existing_capability | `craft.bop.staging.lifecycle.change.apply` |
| Craft | `capability:craft.bop.staging.read` | existing_capability | `craft.bop.staging.read` |
| Craft | `rest:GET:/api/bop/versions/{version_gid}/staging` | existing_capability | `craft.bop.staging.read` |
| Craft | `capability:craft.bop.structure.outline.get` | existing_capability | `craft.bop.structure.outline.get` |
| Craft | `capability:craft.bop.template.change.apply` | existing_capability | `craft.bop.template.change.apply` |
...
| Craft | `capability:craft.bop.version.freeze.change.apply` | existing_capability | `craft.bop.version.freeze.change.apply` |
...
| Craft | `capability:craft.bop.version.layout.change.apply` | existing_capability | `craft.bop.version.layout.change.apply` |
| Craft | `capability:craft.bop.version.legacy_read` | existing_capability | `craft.bop.version.legacy_read` |
| Craft | `rest:GET:/api/bop/versions/{gid}/layout-config` | existing_capability | `craft.bop.version.legacy_read` |
| Craft | `rest:GET:/api/bop/versions/{version_gid}/bop-tree` | existing_capability | `craft.bop.version.legacy_read` |
| Craft | `rest:GET:/api/bop/versions/{version_gid}/station-part-map` | existing_capability | `craft.bop.version.legacy_read` |
| Craft | `capability:craft.bop.version.lifecycle.change.apply` | existing_capability | `craft.bop.version.lifecycle.change.apply` |
| Craft | `rest:DELETE:/api/bop/version-families/{family_gid}/archive` | existing_capability | `craft.bop.version.lifecycle.change.apply` |
| Craft | `rest:POST:/api/bop/version-families/{family_gid}/archive` | existing_capability | `craft.bop.version.lifecycle.change.apply` |
| Craft | `rest:POST:/api/bop/versions/{gid}/publish` | existing_capability | `craft.bop.version.lifecycle.change.apply` |
...
| Craft | `capability:craft.bop.version.snapshot.change.apply` | existing_capability | `craft.bop.version.snapshot.change.apply` |
...
| Craft | `capability:craft.data_exchange.lark.read` | existing_capability | `craft.data_exchange.lark.read` |
| Craft | `capability:craft.data_exchange.lark.write` | existing_capability | `craft.data_exchange.lark.write` |
...
| Craft | `capability:craft.ebom.legacy_read` | existing_capability | `craft.ebom.legacy_read` |
| Craft | `rest:GET:/api/ebom/diff` | existing_capability | `craft.ebom.legacy_read` |
| Craft | `capability:craft.ebom.part.bulk_create` | existing_capability | `craft.ebom.part.bulk_create` |
| Craft | `capability:craft.ebom.part.create` | existing_capability | `craft.ebom.part.create` |
| Craft | `capability:craft.ebom.part.delete` | existing_capability | `craft.ebom.part.delete` |
| Craft | `capability:craft.ebom.part.update` | existing_capability | `craft.ebom.part.update` |
...
| Craft | `capability:craft.ebom.snapshot.delete` | existing_capability | `craft.ebom.snapshot.delete` |
| Craft | `capability:craft.ebom.snapshot.status.update` | existing_capability | `craft.ebom.snapshot.status.update` |
| Craft | `capability:craft.ebom.snapshot.update` | existing_capability | `craft.ebom.snapshot.update` |
| Craft | `capability:craft.ebom.snapshot.vpps_stats.update` | existing_capability | `craft.ebom.snapshot.vpps_stats.update` |
| Craft | `capability:craft.ebom.vpps_check.read` | existing_capability | `craft.ebom.vpps_check.read` |
| Craft | `rest:GET:/api/ebom/vpps_check` | existing_capability | `craft.ebom.vpps_check.read` |
| Craft | `capability:craft.gbop.catalog.read` | existing_capability | `craft.gbop.catalog.read` |
...
| Craft | `capability:craft.gbop.entity.change.apply` | existing_capability | `craft.gbop.entity.change.apply` |
| Craft | `capability:craft.gbop.import.change.apply` | existing_capability | `craft.gbop.import.change.apply` |
| Craft | `capability:craft.gbop.import.tc.change.apply` | existing_capability | `craft.gbop.import.tc.change.apply` |
...
| Craft | `capability:craft.gbop.navigation.change.apply` | existing_capability | `craft.gbop.navigation.change.apply` |
| Craft | `capability:craft.gbop.navigation.read` | existing_capability | `craft.gbop.navigation.read` |
| Craft | `capability:craft.gbop.process_hierarchy.read` | existing_capability | `craft.gbop.process_hierarchy.read` |
...
| Craft | `capability:craft.gbop.station_autolink.change.apply` | existing_capability | `craft.gbop.station_autolink.change.apply` |
| Craft | `capability:craft.gbop.station_autolink.preview` | existing_capability | `craft.gbop.station_autolink.preview` |
| Craft | `rest:GET:/api/gbop/bop-versions/{bop_gid}/station-autolink-preview` | existing_capability | `craft.gbop.station_autolink.preview` |
| Craft | `capability:craft.gbop.version.change.apply` | existing_capability | `craft.gbop.version.change.apply` |
| Craft | `capability:craft.library.change.apply` | existing_capability | `craft.library.change.apply` |
| Craft | `capability:craft.library.read` | existing_capability | `craft.library.read` |
...
| Craft | `capability:craft.standard_operation.change.apply` | existing_capability | `craft.standard_operation.change.apply` |
...
| Knowledge | `capability:knowledge.hub.change.apply` | existing_capability | `knowledge.hub.change.apply` |
| Knowledge | `capability:knowledge.hub.read` | existing_capability | `knowledge.hub.read` |
...
| Ontology | `rest:GET:/api/bop/entries/{entry_gid}/entity-props` | excluded | — |
| Ontology | `rest:GET:/api/ontology/agent-schema` | excluded | — |
| Ontology | `rest:GET:/api/ontology/classes/{gid}/individuals` | excluded | — |
| Ontology | `rest:GET:/api/ontology/db-tables` | excluded | — |
| Ontology | `rest:GET:/api/ontology/node-type-config` | excluded | — |
| Ontology | `rest:GET:/api/ontology/node-type-suggestions` | excluded | — |
| Ontology | `rest:GET:/api/ontology/schema-diff` | excluded | — |
| Ontology | `rest:GET:/api/ontology/unbound-classes` | excluded | — |
| Ontology | `rest:PATCH:/api/bop/entries/{entry_gid}/entity-props` | excluded | — |
| Ontology | `rest:POST:/api/ontology/classes/{gid}/sync-from-table` | excluded | — |
| Ontology | `rest:POST:/api/ontology/seed` | excluded | — |
| Ontology | `rest:POST:/api/ontology/validate/{entry_gid}` | excluded | — |
