...
| Base Platform | `rest:DELETE:/api/import-export/templates/{gid}` | new_capability | `base.export_template.change.apply` |
...
| Craft | `agent_tool:generate_canvas` | new_capability | `craft.canvas.change.apply` |
| Craft | `agent_tool:run_skill_canvas` | new_capability | `craft.canvas.change.apply` |
| Craft | `rest:DELETE:/api/canvases/{gid}` | new_capability | `craft.canvas.change.apply` |
| Craft | `rest:PATCH:/api/canvases/{gid}/shared` | new_capability | `craft.canvas.change.apply` |
| Craft | `rest:POST:/api/canvases` | new_capability | `craft.canvas.change.apply` |
| Craft | `agent_tool:get_canvas_state` | new_capability | `craft.canvas.read` |
| Craft | `agent_tool:get_selected_elements` | new_capability | `craft.canvas.read` |
| Craft | `rest:GET:/api/canvases` | new_capability | `craft.canvas.read` |
| Craft | `rest:GET:/api/canvases/{gid}` | new_capability | `craft.canvas.read` |
| Craft | `rest:POST:/api/import-export/export/diff-lark-sheet` | new_capability | `craft.data_exchange.export` |
| Craft | `rest:POST:/api/import-export/export/diff-report` | new_capability | `craft.data_exchange.export` |
| Craft | `rest:POST:/api/import-export/export/excel` | new_capability | `craft.data_exchange.export` |
| Craft | `rest:DELETE:/api/ebom/parts/{gid}` | new_capability | `craft.ebom.change.apply` |
| Craft | `rest:DELETE:/api/ebom/snapshots/{gid}` | new_capability | `craft.ebom.change.apply` |
| Craft | `rest:PATCH:/api/ebom/parts/{gid}` | new_capability | `craft.ebom.change.apply` |
| Craft | `rest:PATCH:/api/ebom/snapshots/{gid}` | new_capability | `craft.ebom.change.apply` |
| Craft | `rest:PATCH:/api/ebom/snapshots/{gid}/status` | new_capability | `craft.ebom.change.apply` |
| Craft | `rest:PATCH:/api/ebom/snapshots/{gid}/vpps-stats` | new_capability | `craft.ebom.change.apply` |
| Craft | `rest:POST:/api/ebom/snapshots` | new_capability | `craft.ebom.change.apply` |
| Craft | `rest:POST:/api/ebom/snapshots/{gid}/parts` | new_capability | `craft.ebom.change.apply` |
| Craft | `rest:POST:/api/ebom/snapshots/{gid}/parts/batch` | new_capability | `craft.ebom.change.apply` |
| Craft | `rest:GET:/api/ebom/diff` | new_capability | `craft.ebom.read` |
| Craft | `rest:GET:/api/ebom/snapshots` | new_capability | `craft.ebom.read` |
| Craft | `rest:GET:/api/ebom/snapshots/{gid}` | new_capability | `craft.ebom.read` |
| Craft | `rest:GET:/api/ebom/snapshots/{gid}/parts` | new_capability | `craft.ebom.read` |
| Craft | `rest:GET:/api/ebom/vpps_check` | new_capability | `craft.ebom.read` |
| Craft | `rest:DELETE:/api/gbop/entries/{gid}` | new_capability | `craft.gbop.change.apply` |
| Craft | `rest:DELETE:/api/gbop/entry-links/{gid}` | new_capability | `craft.gbop.change.apply` |
| Craft | `rest:DELETE:/api/gbop/operations/{gid}` | new_capability | `craft.gbop.change.apply` |
| Craft | `rest:DELETE:/api/gbop/processes/{gid}` | new_capability | `craft.gbop.change.apply` |
| Craft | `rest:DELETE:/api/gbop/version-families/{family_gid}/archive` | new_capability | `craft.gbop.change.apply` |
| Craft | `rest:PATCH:/api/gbop/entries/{gid}` | new_capability | `craft.gbop.change.apply` |
| Craft | `rest:PATCH:/api/gbop/operations/{gid}` | new_capability | `craft.gbop.change.apply` |
| Craft | `rest:PATCH:/api/gbop/processes/{gid}` | new_capability | `craft.gbop.change.apply` |
| Craft | `rest:PATCH:/api/gbop/versions/{gid}` | new_capability | `craft.gbop.change.apply` |
| Craft | `rest:POST:/api/gbop/bop-versions/{bop_gid}/station-autolink` | new_capability | `craft.gbop.change.apply` |
| Craft | `rest:POST:/api/gbop/bop-versions/{bop_gid}/station-autolink-undo` | new_capability | `craft.gbop.change.apply` |
| Craft | `rest:POST:/api/gbop/entries` | new_capability | `craft.gbop.change.apply` |
| Craft | `rest:POST:/api/gbop/entry-links` | new_capability | `craft.gbop.change.apply` |
| Craft | `rest:POST:/api/gbop/operations` | new_capability | `craft.gbop.change.apply` |
| Craft | `rest:POST:/api/gbop/pbom-versions/{pbom_gid}/vpps-auto-link` | new_capability | `craft.gbop.change.apply` |
| Craft | `rest:POST:/api/gbop/pbom-versions/{pbom_gid}/vpps-auto-link-confirm` | new_capability | `craft.gbop.change.apply` |
| Craft | `rest:POST:/api/gbop/processes` | new_capability | `craft.gbop.change.apply` |
| Craft | `rest:POST:/api/gbop/version-families/{family_gid}/archive` | new_capability | `craft.gbop.change.apply` |
| Craft | `rest:POST:/api/gbop/versions` | new_capability | `craft.gbop.change.apply` |
| Craft | `rest:POST:/api/gbop/versions/{gid}/freeze` | new_capability | `craft.gbop.change.apply` |
| Craft | `rest:POST:/api/gbop/versions/{source_gid}/fork` | new_capability | `craft.gbop.change.apply` |
...
| Craft | `rest:GET:/api/gbop/bop-versions/{bop_gid}/station-autolink-preview` | new_capability | `craft.gbop.read` |
| Craft | `rest:GET:/api/gbop/entries/{entry_gid}/links` | new_capability | `craft.gbop.read` |
| Craft | `rest:GET:/api/gbop/pbom-versions/{pbom_gid}/gbop-nav-link-summary` | new_capability | `craft.gbop.read` |
| Craft | `rest:GET:/api/gbop/pbom-versions/{pbom_gid}/process-hierarchy` | new_capability | `craft.gbop.read` |
| Craft | `rest:GET:/api/gbop/pbom-versions/{pbom_gid}/vpps-auto-link-status` | new_capability | `craft.gbop.read` |
| Craft | `rest:GET:/api/gbop/versions` | new_capability | `craft.gbop.read` |
...
| Craft | `rest:DELETE:/api/bop/layout_templates/{gid}` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:DELETE:/api/craft_lib/fasteners/{gid}` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:DELETE:/api/craft_lib/part_names/{gid}` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:DELETE:/api/craft_lib/tools/{gid}` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:DELETE:/api/factory/equipments/{gid}` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:DELETE:/api/factory/fixtures/{gid}` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:DELETE:/api/factory/sections/{gid}` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:DELETE:/api/factory/stations/{gid}` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:DELETE:/api/factory/tools/{gid}` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:DELETE:/api/std_op/operations/{gid}` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:PATCH:/api/bop/factories/{gid}` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:PATCH:/api/bop/factory_sections/{gid}` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:PATCH:/api/bop/factory_stations/{gid}` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:PATCH:/api/bop/layout_templates/{gid}` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:PATCH:/api/craft_lib/equipments/{gid}` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:PATCH:/api/craft_lib/fasteners/{gid}` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:PATCH:/api/craft_lib/fixtures/{gid}` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:PATCH:/api/craft_lib/part_names/{gid}` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:PATCH:/api/craft_lib/tools/{gid}` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:PATCH:/api/factory/equipments/{gid}` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:PATCH:/api/factory/fixtures/{gid}` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:PATCH:/api/factory/sections/{gid}` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:PATCH:/api/factory/stations/{gid}` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:PATCH:/api/factory/tools/{gid}` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:PATCH:/api/std_op/operations/{gid}` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:POST:/api/bop/factories` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:POST:/api/bop/factories/{factory_gid}/layout_templates` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:POST:/api/bop/factories/{factory_gid}/sections` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:POST:/api/bop/factory_sections/{section_gid}/stations` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:POST:/api/bop/layout_templates/{gid}/apply` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:POST:/api/craft_lib/equipments` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:POST:/api/craft_lib/equipments/{gid}/obsolete` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:POST:/api/craft_lib/fasteners` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:POST:/api/craft_lib/fixtures` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:POST:/api/craft_lib/fixtures/{gid}/obsolete` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:POST:/api/craft_lib/part_names` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:POST:/api/craft_lib/part_names/batch_accept_alias` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:POST:/api/craft_lib/part_names/batch_add_from_pbom` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:POST:/api/craft_lib/part_names/{gid}/accept_alias` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:POST:/api/craft_lib/tools` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:POST:/api/craft_lib/tools/{gid}/obsolete` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:POST:/api/factory/equipments` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:POST:/api/factory/equipments/{gid}/maintenance` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:POST:/api/factory/equipments/{gid}/return` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:POST:/api/factory/equipments/{gid}/scrap` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:POST:/api/factory/fixtures` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:POST:/api/factory/fixtures/{gid}/maintenance` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:POST:/api/factory/fixtures/{gid}/return` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:POST:/api/factory/fixtures/{gid}/scrap` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:POST:/api/factory/sections` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:POST:/api/factory/stations` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:POST:/api/factory/tools` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:POST:/api/factory/tools/{gid}/maintenance` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:POST:/api/factory/tools/{gid}/return` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:POST:/api/factory/tools/{gid}/scrap` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:POST:/api/std_op/operations` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:POST:/api/std_op/operations/{gid}/clone-to-post` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:POST:/api/std_op/operations/{gid}/deprecate` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:POST:/api/std_op/operations/{gid}/publish` | new_capability | `craft.manufacturing_resource.change.apply` |
| Craft | `rest:GET:/api/bop/factories` | new_capability | `craft.manufacturing_resource.read` |
| Craft | `rest:GET:/api/bop/factories/{factory_gid}/layout_templates` | new_capability | `craft.manufacturing_resource.read` |
| Craft | `rest:GET:/api/bop/factories/{factory_gid}/sections` | new_capability | `craft.manufacturing_resource.read` |
| Craft | `rest:GET:/api/bop/factories/{gid}` | new_capability | `craft.manufacturing_resource.read` |
| Craft | `rest:GET:/api/bop/factory_sections/{section_gid}/stations` | new_capability | `craft.manufacturing_resource.read` |
| Craft | `rest:GET:/api/bop/layout_templates/{gid}` | new_capability | `craft.manufacturing_resource.read` |
| Craft | `rest:GET:/api/craft_lib/equipments` | new_capability | `craft.manufacturing_resource.read` |
| Craft | `rest:GET:/api/craft_lib/fasteners` | new_capability | `craft.manufacturing_resource.read` |
| Craft | `rest:GET:/api/craft_lib/fixtures` | new_capability | `craft.manufacturing_resource.read` |
| Craft | `rest:GET:/api/craft_lib/part_names` | new_capability | `craft.manufacturing_resource.read` |
| Craft | `rest:GET:/api/craft_lib/tools` | new_capability | `craft.manufacturing_resource.read` |
| Craft | `rest:GET:/api/factory/equipments` | new_capability | `craft.manufacturing_resource.read` |
| Craft | `rest:GET:/api/factory/fixtures` | new_capability | `craft.manufacturing_resource.read` |
| Craft | `rest:GET:/api/factory/sections` | new_capability | `craft.manufacturing_resource.read` |
| Craft | `rest:GET:/api/factory/stations` | new_capability | `craft.manufacturing_resource.read` |
