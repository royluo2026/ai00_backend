...
| Base Platform | `workmanship_base_capability_evidence` | Base Platform | base |
| Base Platform | `workmanship_base_capability_finding_subjects` | Base Platform | base |
| Base Platform | `workmanship_base_capability_findings` | Base Platform | base |
| Base Platform | `workmanship_base_capability_governance_migrations` | Base Platform | base |
| Base Platform | `workmanship_base_capability_health_rollups` | Base Platform | base |
| Base Platform | `workmanship_base_capability_implementation_nodes` | Base Platform | base |
| Base Platform | `workmanship_base_capability_implementation_relations` | Base Platform | base |
...
| Base Platform | `workmanship_base_revision_commits` | Base Platform | base |
| Base Platform | `workmanship_base_revision_diffs` | Base Platform | base |
...
| Factory | `workmanship_factory_factory_equipments` | Factory | factory |
| Factory | `workmanship_factory_factory_fixtures` | Factory | factory |
| Factory | `workmanship_factory_factory_layout_templates` | Factory | factory |
| Factory | `workmanship_factory_factory_lines` | Factory | factory |
| Factory | `workmanship_factory_factory_sections` | Factory | factory |
...
| Knowledge | `workmanship_know_reference_datasets` | Knowledge | knowledge |
