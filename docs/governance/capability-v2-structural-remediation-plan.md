...
- Blocker evidence: `docs/governance/integration-structural-web-remediation.json`; `{'end_line': 43, 'sha256': 'fe1bfdd9844a78f786f85287e44d451fc0bf96b4538c37411558624b2aec7d0d', 'source_path': 'plugins/integration/integration_backend/capabilities/provider.py', 'start_line': 43}`; Migrated through the reviewed public owner service and generated capability evidence.
