...
Frontend source commits: `3612c7a00d0528cd0aae41cebf3129446ef52a56` (`build: package governed Windows x64 App`), `27501b128d25ea3b732ca26f599caa607c23629d` (legacy update/publication retirement, installed Electron reuse and scanner compatibility), and `2ea7ed1f9eb4d9f6b3a98847d563bcaa69e80fe2` (production main-process EPIPE protection), and `7e4bb5343ca56bcd06cda1e95ca90a77da4b09b1` (legacy publisher retirement, App-version anti-downgrade and mandatory final-package inspection). Backend source: `0d004c3976161931c989bc4e05523535a8c22ced` (`governance: define Electron App release evidence`). A following evidence-only commit binds these exact commits, source trees, generated closure and actual file hashes in `docs/acceptance/electron-app-release-candidate.json`.
...
Installer SHA256: `41030c6940be9d55a698690bb48d300f3760e758f02bfe06965b56eabf937045`. Actual `Get-AuthenticodeSignature` result: `NotSigned`. The empty Host signature and explicit inert local manifest cannot pass Host startup trust. No installer was executed.
...
- Actual unpacked artifact inspection passed: 79 external files and 1,108 ASAR entries; exact Connector file allowlist, required native unpack and forbidden contents verified. The Electron Builder `afterPack` hook enforces the same unpacked and ASAR checks for every supported build.
