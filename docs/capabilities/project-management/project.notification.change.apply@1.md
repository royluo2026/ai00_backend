# project.notification.change.apply@1

Execute the reviewed project.notification.change.apply project outcome.
...
```json
{
  "capability_id": "project.notification.change.apply",
