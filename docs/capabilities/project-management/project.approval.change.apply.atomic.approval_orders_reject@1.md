# project.approval.change.apply.atomic.approval_orders_reject@1

Execute Project Management operation approval.orders.reject.
...
```json
{
  "capability_id": "project.approval.change.apply.atomic.approval_orders_reject",
