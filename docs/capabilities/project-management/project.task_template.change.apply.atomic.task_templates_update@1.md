# project.task_template.change.apply.atomic.task_templates_update@1

Execute Project Management operation task_templates.update.
...
```json
{
  "capability_id": "project.task_template.change.apply.atomic.task_templates_update",
