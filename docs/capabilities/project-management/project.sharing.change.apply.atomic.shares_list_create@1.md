# project.sharing.change.apply.atomic.shares_list_create@1

Execute Project Management operation shares.list.create.
...
```json
{
  "capability_id": "project.sharing.change.apply.atomic.shares_list_create",
