# project.workbench.change.apply.atomic.workbenches_update@1

Execute Project Management operation workbenches.update.
...
```json
{
  "capability_id": "project.workbench.change.apply.atomic.workbenches_update",
