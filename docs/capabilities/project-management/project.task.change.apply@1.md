# project.task.change.apply@1

Execute the reviewed project.task.change.apply project outcome.
...
```json
{
  "capability_id": "project.task.change.apply",
  "catalog_release": "rel_b6846f0f3faea2788a65130a4a59a5fe",
  "major_version": 1,
  "payload": {
    "arguments": {},
    "operation": "task_dependencies.create"
  }
}
```
