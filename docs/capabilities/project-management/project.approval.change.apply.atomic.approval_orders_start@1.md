# project.approval.change.apply.atomic.approval_orders_start@1

Execute Project Management operation approval.orders.start.
...
```json
{
  "capability_id": "project.approval.change.apply.atomic.approval_orders_start",
