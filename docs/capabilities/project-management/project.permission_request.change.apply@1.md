# project.permission_request.change.apply@1

Execute the reviewed project.permission_request.change.apply project outcome.
...
```json
{
  "capability_id": "project.permission_request.change.apply",
  "catalog_release": "rel_a3cc0d777045278c8b7cd40fd7ea1ec5",
  "major_version": 1,
  "payload": {
    "arguments": {},
    "operation": "permission_requests.approve"
  }
}
```
