# project.sharing.change.apply.atomic.shares_item_create@1

Execute Project Management operation shares.item.create.
...
```json
{
  "capability_id": "project.sharing.change.apply.atomic.shares_item_create",
