# project.approval.change.apply.atomic.approval_scope_upgrade_create@1

Execute Project Management operation approval.scope_upgrade.create.
...
```json
{
  "capability_id": "project.approval.change.apply.atomic.approval_scope_upgrade_create",
