# project.workbench.read.atomic.workbenches_overrides_get@1

Execute Project Management operation workbenches.overrides.get.
...
```json
{
  "capability_id": "project.workbench.read.atomic.workbenches_overrides_get",
