# project.knowledge_comment.list@1

Read knowledge_comment list within the authenticated tenant and participant policy.

## 使用判断

- 适用：Read knowledge_comment list within the authenticated tenant and participant policy.
...
```json
{
  "capability_id": "project.knowledge_comment.list",
