# project.task_template.change.apply.atomic.task_templates_instantiate@1

Execute Project Management operation task_templates.instantiate.
...
```json
{
  "capability_id": "project.task_template.change.apply.atomic.task_templates_instantiate",
