# project.collaboration.change.apply.atomic.collaboration_sessions_end@1

Execute Project Management operation collaboration.sessions.end.
...
```json
{
  "capability_id": "project.collaboration.change.apply.atomic.collaboration_sessions_end",
