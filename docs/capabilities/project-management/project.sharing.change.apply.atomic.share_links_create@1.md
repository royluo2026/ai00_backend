# project.sharing.change.apply.atomic.share_links_create@1

Execute Project Management operation share_links.create.
...
```json
{
  "capability_id": "project.sharing.change.apply.atomic.share_links_create",
