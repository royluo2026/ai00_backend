# project.notification.change.apply.atomic.notifications_create@1

Execute Project Management operation notifications.create.
...
```json
{
  "capability_id": "project.notification.change.apply.atomic.notifications_create",
