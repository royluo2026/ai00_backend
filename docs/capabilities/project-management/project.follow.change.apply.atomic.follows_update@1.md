# project.follow.change.apply.atomic.follows_update@1

Execute Project Management operation follows.update.
...
```json
{
  "capability_id": "project.follow.change.apply.atomic.follows_update",
