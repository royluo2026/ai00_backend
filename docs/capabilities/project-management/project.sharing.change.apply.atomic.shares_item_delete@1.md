# project.sharing.change.apply.atomic.shares_item_delete@1

Execute Project Management operation shares.item.delete.
...
```json
{
  "capability_id": "project.sharing.change.apply.atomic.shares_item_delete",
