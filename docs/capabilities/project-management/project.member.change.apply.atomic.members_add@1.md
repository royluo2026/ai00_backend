# project.member.change.apply.atomic.members_add@1

Execute Project Management operation members.add.
...
```json
{
  "capability_id": "project.member.change.apply.atomic.members_add",
