# project.approval.read.atomic.approval_orders_search@1

Execute Project Management operation approval.orders.search.
...
```json
{
  "capability_id": "project.approval.read.atomic.approval_orders_search",
