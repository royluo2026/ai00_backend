# project.list.read.atomic.item_entries_get@1

Execute Project Management operation item_entries.get.
...
```json
{
  "capability_id": "project.list.read.atomic.item_entries_get",
