# project.collaboration.change.apply@1

Execute the reviewed project.collaboration.change.apply project outcome.
...
```json
{
  "capability_id": "project.collaboration.change.apply",
