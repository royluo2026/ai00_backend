# project.sharing.read.atomic.share_links_resolve@1

Execute Project Management operation share_links.resolve.
...
```json
{
  "capability_id": "project.sharing.read.atomic.share_links_resolve",
