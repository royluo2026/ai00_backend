# project.attachment.resolve@1

Resolve one historical attachment proven to belong to an authorized project_management business parent into an immutable ArtifactRef.

## 使用判断

- 适用：Resolve one historical attachment proven to belong to an authorized project_management business parent into an immutable ArtifactRef.
...
```json
{
  "capability_id": "project.attachment.resolve",
