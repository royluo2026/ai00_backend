# project.issue.change.apply.atomic.issues_promote@1

Execute Project Management operation issues.promote.
...
```json
{
  "capability_id": "project.issue.change.apply.atomic.issues_promote",
