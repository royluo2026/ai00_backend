# project.issue.change.apply.atomic.issues_update@2

Execute Project Management operation issues.update.
...
```json
{
  "capability_id": "project.issue.change.apply.atomic.issues_update",
