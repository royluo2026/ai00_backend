# project.issue.change.apply.atomic.issues_create@1

Execute Project Management operation issues.create.
...
```json
{
  "capability_id": "project.issue.change.apply.atomic.issues_create",
