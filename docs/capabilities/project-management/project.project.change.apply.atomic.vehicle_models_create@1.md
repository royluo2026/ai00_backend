# project.project.change.apply.atomic.vehicle_models_create@1

Execute Project Management operation vehicle_models.create.
...
```json
{
  "capability_id": "project.project.change.apply.atomic.vehicle_models_create",
