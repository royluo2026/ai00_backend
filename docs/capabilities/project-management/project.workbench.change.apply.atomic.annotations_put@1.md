# project.workbench.change.apply.atomic.annotations_put@1

Execute Project Management operation annotations.put.
...
```json
{
  "capability_id": "project.workbench.change.apply.atomic.annotations_put",
