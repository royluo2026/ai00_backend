# project.approval.change.apply.atomic.approval_orders_create@1

Execute Project Management operation approval.orders.create.
...
```json
{
  "capability_id": "project.approval.change.apply.atomic.approval_orders_create",
