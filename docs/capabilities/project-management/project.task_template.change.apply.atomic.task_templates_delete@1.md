# project.task_template.change.apply.atomic.task_templates_delete@1

Execute Project Management operation task_templates.delete.
...
```json
{
  "capability_id": "project.task_template.change.apply.atomic.task_templates_delete",
