# project.task.read.atomic.task_dependencies_list@1

Execute Project Management operation task_dependencies.list.
...
```json
{
  "capability_id": "project.task.read.atomic.task_dependencies_list",
