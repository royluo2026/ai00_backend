# project.workbench.change.apply.atomic.workbenches_overrides_upsert@1

Execute Project Management operation workbenches.overrides.upsert.
...
```json
{
  "capability_id": "project.workbench.change.apply.atomic.workbenches_overrides_upsert",
