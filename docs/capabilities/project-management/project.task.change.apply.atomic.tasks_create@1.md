# project.task.change.apply.atomic.tasks_create@1

Execute Project Management operation tasks.create.
...
```json
{
  "capability_id": "project.task.change.apply.atomic.tasks_create",
