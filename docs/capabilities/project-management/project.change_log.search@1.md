# project.change_log.search@1

Read change_log search within the authenticated tenant and participant policy.

## 使用判断

- 适用：Read change_log search within the authenticated tenant and participant policy.
...
```json
{
  "capability_id": "project.change_log.search",
