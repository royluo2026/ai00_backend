# project.follow.change.apply.atomic.follows_delete@1

Execute Project Management operation follows.delete.
...
```json
{
  "capability_id": "project.follow.change.apply.atomic.follows_delete",
