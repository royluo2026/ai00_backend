# project.permission_request.change.apply.atomic.permission_requests_reject@1

Execute Project Management operation permission_requests.reject.

## 使用判断

- 适用：A governed consumer needs exactly this Project Management operation.
...
```json
{
  "capability_id": "project.permission_request.change.apply.atomic.permission_requests_reject",
