# project.sharing.change.apply.atomic.shares_list_delete@1

Execute Project Management operation shares.list.delete.
...
```json
{
  "capability_id": "project.sharing.change.apply.atomic.shares_list_delete",
