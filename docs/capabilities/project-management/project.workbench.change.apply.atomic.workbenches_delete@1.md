# project.workbench.change.apply.atomic.workbenches_delete@1

Execute Project Management operation workbenches.delete.
...
```json
{
  "capability_id": "project.workbench.change.apply.atomic.workbenches_delete",
