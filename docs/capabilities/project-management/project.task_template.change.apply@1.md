# project.task_template.change.apply@1

Execute the reviewed project.task_template.change.apply project outcome.
  ...
  "properties": {
    ...
    "operation": {
      "enum": [
        ...
        "task_templates.instantiate",
        "task_templates.items.create",
        "task_templates.items.delete",
        "task_templates.items.update",
...
```json
{
  "capability_id": "project.task_template.change.apply",
  "catalog_release": "rel_909b49765f221187a4e1ecc5e367e56f",
  "major_version": 1,
  "payload": {
    "arguments": {},
    "operation": "task_templates.create"
  }
}
```
