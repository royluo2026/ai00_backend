# project.task.change.apply.atomic.task_dependencies_create@1

Execute Project Management operation task_dependencies.create.
...
```json
{
  "capability_id": "project.task.change.apply.atomic.task_dependencies_create",
