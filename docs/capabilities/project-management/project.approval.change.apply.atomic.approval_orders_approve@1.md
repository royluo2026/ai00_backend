# project.approval.change.apply.atomic.approval_orders_approve@1

Execute Project Management operation approval.orders.approve.
...
```json
{
  "capability_id": "project.approval.change.apply.atomic.approval_orders_approve",
