# project.list.change.apply.atomic.item_entries_replace@1

Execute Project Management operation item_entries.replace.
...
```json
{
  "capability_id": "project.list.change.apply.atomic.item_entries_replace",
