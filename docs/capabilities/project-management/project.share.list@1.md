# project.share.list@1

Read share list within the authenticated tenant and participant policy.

## 使用判断

- 适用：Read share list within the authenticated tenant and participant policy.
...
```json
{
  "capability_id": "project.share.list",
