# project.task.change.apply.atomic.tasks_update@2

Execute Project Management operation tasks.update.
...
```json
{
  "capability_id": "project.task.change.apply.atomic.tasks_update",
