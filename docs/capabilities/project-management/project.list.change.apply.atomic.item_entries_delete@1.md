# project.list.change.apply.atomic.item_entries_delete@1

Execute Project Management operation item_entries.delete.
...
```json
{
  "capability_id": "project.list.change.apply.atomic.item_entries_delete",
