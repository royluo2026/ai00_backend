# project.task_template.change.apply.atomic.task_templates_items_create@1

Execute Project Management operation task_templates.items.create.
...
```json
{
  "capability_id": "project.task_template.change.apply.atomic.task_templates_items_create",
