# project.workbench.read.atomic.annotations_get@1

Execute Project Management operation annotations.get.
...
```json
{
  "capability_id": "project.workbench.read.atomic.annotations_get",
