# project.task.change.apply.atomic.task_dependencies_update@1

Execute Project Management operation task_dependencies.update.
...
```json
{
  "capability_id": "project.task.change.apply.atomic.task_dependencies_update",
