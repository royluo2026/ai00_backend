# project.list.change.apply.atomic.lists_create@1

Execute Project Management operation lists.create.
...
```json
{
  "capability_id": "project.list.change.apply.atomic.lists_create",
