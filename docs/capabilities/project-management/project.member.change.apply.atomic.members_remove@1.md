# project.member.change.apply.atomic.members_remove@1

Execute Project Management operation members.remove.
...
```json
{
  "capability_id": "project.member.change.apply.atomic.members_remove",
