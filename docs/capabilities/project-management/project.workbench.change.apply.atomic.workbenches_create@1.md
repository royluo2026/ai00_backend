# project.workbench.change.apply.atomic.workbenches_create@1

Execute Project Management operation workbenches.create.
...
```json
{
  "capability_id": "project.workbench.change.apply.atomic.workbenches_create",
