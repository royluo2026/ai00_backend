# project.project.change.apply.atomic.projects_create@1

Execute Project Management operation projects.create.
...
```json
{
  "capability_id": "project.project.change.apply.atomic.projects_create",
