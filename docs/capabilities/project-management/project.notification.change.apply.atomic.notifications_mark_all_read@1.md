# project.notification.change.apply.atomic.notifications_mark_all_read@1

Execute Project Management operation notifications.mark_all_read.
...
```json
{
  "capability_id": "project.notification.change.apply.atomic.notifications_mark_all_read",
