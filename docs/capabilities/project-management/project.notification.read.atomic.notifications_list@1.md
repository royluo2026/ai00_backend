# project.notification.read.atomic.notifications_list@1

Execute Project Management operation notifications.list.
...
```json
{
  "capability_id": "project.notification.read.atomic.notifications_list",
