# project.task_template.read.atomic.task_templates_get@1

Execute Project Management operation task_templates.get.
...
```json
{
  "capability_id": "project.task_template.read.atomic.task_templates_get",
