# project.task_template.read.atomic.task_templates_list@1

Execute Project Management operation task_templates.list.
...
```json
{
  "capability_id": "project.task_template.read.atomic.task_templates_list",
