# project.follow.change.apply.atomic.follows_create@1

Execute Project Management operation follows.create.
...
```json
{
  "capability_id": "project.follow.change.apply.atomic.follows_create",
