# project.notification.read.atomic.notifications_unread_count@1

Execute Project Management operation notifications.unread_count.
...
```json
{
  "capability_id": "project.notification.read.atomic.notifications_unread_count",
