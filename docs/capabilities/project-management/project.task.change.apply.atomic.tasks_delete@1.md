# project.task.change.apply.atomic.tasks_delete@1

Execute Project Management operation tasks.delete.
...
```json
{
  "capability_id": "project.task.change.apply.atomic.tasks_delete",
