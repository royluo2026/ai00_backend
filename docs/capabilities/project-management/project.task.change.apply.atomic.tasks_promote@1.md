# project.task.change.apply.atomic.tasks_promote@1

Execute Project Management operation tasks.promote.
...
```json
{
  "capability_id": "project.task.change.apply.atomic.tasks_promote",
