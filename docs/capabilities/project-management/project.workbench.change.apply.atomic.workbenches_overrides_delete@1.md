# project.workbench.change.apply.atomic.workbenches_overrides_delete@1

Execute Project Management operation workbenches.overrides.delete.
...
```json
{
  "capability_id": "project.workbench.change.apply.atomic.workbenches_overrides_delete",
