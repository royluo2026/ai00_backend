# project.task.change.apply.atomic.task_dependencies_delete@1

Execute Project Management operation task_dependencies.delete.
...
```json
{
  "capability_id": "project.task.change.apply.atomic.task_dependencies_delete",
