# project.permission_request.read@1

Execute the reviewed project.permission_request.read project outcome.
...
- 授权策略：`project_management.v2:project.read`
- 自动化等级：`A2`
- 数据分类：`confidential`
- Delegation：`scoped`
- 认证新鲜度：0 秒
...
```json
{
  "capability_id": "project.permission_request.read",
