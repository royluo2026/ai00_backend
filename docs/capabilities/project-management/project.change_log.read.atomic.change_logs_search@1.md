# project.change_log.read.atomic.change_logs_search@1

Execute Project Management operation change_logs.search.
...
```json
{
  "capability_id": "project.change_log.read.atomic.change_logs_search",
