# project.workbench.change.apply@1

Execute the reviewed project.workbench.change.apply project outcome.
  ...
  "properties": {
    ...
    "operation": {
      "enum": [
        ...
        "workbenches.create",
        "workbenches.delete",
        "workbenches.overrides.delete",
        "workbenches.overrides.upsert",
        "workbenches.update"
      ],
      "maxLength": 128,
      "minLength": 1,
...
```json
{
  "capability_id": "project.workbench.change.apply",
  "catalog_release": "rel_900dacb56a1cab69166515ec5b15ed10",
  "major_version": 1,
  "payload": {
    "arguments": {},
    "operation": "annotations.put"
  }
}
```
