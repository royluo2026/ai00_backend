# project.sharing.read.atomic.shares_list_list@1

Execute Project Management operation shares.list.list.
...
```json
{
  "capability_id": "project.sharing.read.atomic.shares_list_list",
