# project.permission_request.read.atomic.permission_requests_list@1

Execute Project Management operation permission_requests.list.
...
```json
{
  "capability_id": "project.permission_request.read.atomic.permission_requests_list",
