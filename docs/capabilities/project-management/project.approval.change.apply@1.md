# project.approval.change.apply@1

Execute the reviewed project.approval.change.apply project outcome.
...
```json
{
  ...
  "properties": {
    ...
    "operation": {
      "enum": [
        "approval.orders.approve",
        "approval.orders.create",
        "approval.orders.reject",
        "approval.orders.start",
        "approval.orders.withdraw",
        "approval.scope_upgrade.create"
      ],
      "maxLength": 128,
      "minLength": 1,
      "type": "string"
...
```json
{
  "capability_id": "project.approval.change.apply",
  "catalog_release": "rel_331a207029a6b2186322dcabb43f675c",
  "major_version": 1,
  "payload": {
    "arguments": {},
    "operation": "approval.orders.approve"
  }
}
```
