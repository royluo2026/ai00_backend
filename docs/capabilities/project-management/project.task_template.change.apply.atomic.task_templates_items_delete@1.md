# project.task_template.change.apply.atomic.task_templates_items_delete@1

Execute Project Management operation task_templates.items.delete.
...
```json
{
  "capability_id": "project.task_template.change.apply.atomic.task_templates_items_delete",
