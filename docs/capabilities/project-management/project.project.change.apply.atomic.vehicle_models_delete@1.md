# project.project.change.apply.atomic.vehicle_models_delete@1

Execute Project Management operation vehicle_models.delete.
...
```json
{
  "capability_id": "project.project.change.apply.atomic.vehicle_models_delete",
