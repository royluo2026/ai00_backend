# project.collaboration.change.apply.atomic.collaboration_sessions_join@1

Execute Project Management operation collaboration.sessions.join.
...
```json
{
  "capability_id": "project.collaboration.change.apply.atomic.collaboration_sessions_join",
