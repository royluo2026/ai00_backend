# project.task_template.change.apply.atomic.task_templates_create@1

Execute Project Management operation task_templates.create.
...
```json
{
  "capability_id": "project.task_template.change.apply.atomic.task_templates_create",
