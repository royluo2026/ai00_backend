# project.project.change.apply.atomic.vehicle_models_update@1

Execute Project Management operation vehicle_models.update.
...
```json
{
  "capability_id": "project.project.change.apply.atomic.vehicle_models_update",
