# project.follow.change.apply@1

Execute the reviewed project.follow.change.apply project outcome.
...
```json
{
  "capability_id": "project.follow.change.apply",
  "catalog_release": "rel_1b40890bffd2481e1cc55591ae4ffb0c",
  "major_version": 1,
  "payload": {
    "arguments": {},
    "operation": "follows.create"
  }
}
```
