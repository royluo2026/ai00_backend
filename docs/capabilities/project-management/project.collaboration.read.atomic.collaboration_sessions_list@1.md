# project.collaboration.read.atomic.collaboration_sessions_list@1

Execute Project Management operation collaboration.sessions.list.
...
```json
{
  "capability_id": "project.collaboration.read.atomic.collaboration_sessions_list",
