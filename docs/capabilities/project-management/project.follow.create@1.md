# project.follow.create@1

Commit follow create within the authenticated tenant and participant policy.

## 使用判断

- 适用：Commit follow create within the authenticated tenant and participant policy.
