# project.project.change.apply.atomic.projects_delete@1

Execute Project Management operation projects.delete.
...
```json
{
  "capability_id": "project.project.change.apply.atomic.projects_delete",
