# project.list.change.apply.atomic.lists_retarget@1

Execute Project Management operation lists.retarget.
...
```json
{
  "capability_id": "project.list.change.apply.atomic.lists_retarget",
