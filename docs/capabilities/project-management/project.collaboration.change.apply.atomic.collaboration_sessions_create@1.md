# project.collaboration.change.apply.atomic.collaboration_sessions_create@1

Execute Project Management operation collaboration.sessions.create.
...
```json
{
  "capability_id": "project.collaboration.change.apply.atomic.collaboration_sessions_create",
