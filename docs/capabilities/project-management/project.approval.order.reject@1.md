# project.approval.order.reject@1

Reject one Project approval order and durably enqueue its notification.

## 使用判断

- 适用：A confirmed reviewer rejects an in-review Project approval order.
