# project.collaboration.read.atomic.collaboration_sessions_get@1

Execute Project Management operation collaboration.sessions.get.
...
```json
{
  "capability_id": "project.collaboration.read.atomic.collaboration_sessions_get",
