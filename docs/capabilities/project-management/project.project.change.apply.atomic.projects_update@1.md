# project.project.change.apply.atomic.projects_update@1

Execute Project Management operation projects.update.
...
```json
{
  "capability_id": "project.project.change.apply.atomic.projects_update",
