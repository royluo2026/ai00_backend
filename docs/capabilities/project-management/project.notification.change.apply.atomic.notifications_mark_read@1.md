# project.notification.change.apply.atomic.notifications_mark_read@1

Execute Project Management operation notifications.mark_read.
...
```json
{
  "capability_id": "project.notification.change.apply.atomic.notifications_mark_read",
