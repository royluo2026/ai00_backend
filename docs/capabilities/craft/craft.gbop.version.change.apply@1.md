# craft.gbop.version.change.apply@1

Create, update, freeze, archive, unarchive, or fork a GBOP version through one governed boundary.

## 使用判断

- 适用：A governed Craft consumer changes GBOP version lifecycle or creates a derived version.
