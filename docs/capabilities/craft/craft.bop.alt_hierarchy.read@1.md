# craft.bop.alt_hierarchy.read@1

Read a bounded BOP hierarchy enriched with linked PBOM CATIA occurrences.

## 使用判断

- 适用：A governed consumer needs the alternative hierarchy projection for one BOP version.
