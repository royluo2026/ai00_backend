# craft.bop.lifecycle.checkpoint.change.apply@1

Create an immutable snapshot checkpoint for a BOP line subtree.

## 使用判断

- 适用：A governed Craft consumer records a named checkpoint before further line changes.
