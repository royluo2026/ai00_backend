...
craft.bop.managed_personal_space.import.preview

## 使用判断

- 适用：craft.bop.managed_personal_space.import.preview
...
```json
{
  "capability_id": "craft.bop.managed_personal_space.import.preview",
