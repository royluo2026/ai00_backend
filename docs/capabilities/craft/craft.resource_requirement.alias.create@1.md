# craft.resource_requirement.alias.create@1

Governed Craft resource requirement alias.create outcome.
...
资源选择器：
- `craft-resource-requirement` ← `resource_gid`（必填）
...
```json
{
  "capability_id": "craft.resource_requirement.alias.create",
