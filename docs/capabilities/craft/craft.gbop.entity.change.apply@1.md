# craft.gbop.entity.change.apply@1

Create, update, delete GBOP entries, process cards, operation cards, and entry links.

## 使用判断

- 适用：A governed Craft consumer mutates one GBOP entity or link.
