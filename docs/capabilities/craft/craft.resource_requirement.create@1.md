# craft.resource_requirement.create@1

Governed Craft resource requirement create outcome.
...
资源选择器：
- `craft-resource-requirement-type` ← `resource_type`（必填）
...
```json
{
  "capability_id": "craft.resource_requirement.create",
