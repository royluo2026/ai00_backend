# craft.bop.managed_personal_space.sync.apply@1

craft.bop.managed_personal_space.sync.apply

## 使用判断

- 适用：craft.bop.managed_personal_space.sync.apply
...
```json
{
  "capability_id": "craft.bop.managed_personal_space.sync.apply",
