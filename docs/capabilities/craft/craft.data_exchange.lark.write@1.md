# craft.data_exchange.lark.write@1

Write bounded rows to user-authorized Lark Sheets or Bitable tables.

## 使用判断

- 适用：A governed Craft consumer writes an approved Lark data target.
