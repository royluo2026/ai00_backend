# craft.bop.entry.relation.list@1

Read one bounded page of direct or descendant BOP entry relations.

## 使用判断

- 适用：A consumer needs governed relations for one entry or its bounded subtree.
