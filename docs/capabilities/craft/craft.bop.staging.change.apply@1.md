# craft.bop.staging.change.apply@1

Create, update, or delete active-version BOP staging entries.

## 使用判断

- 适用：A governed Craft consumer mutates the staging area without promoting entries into the BOP tree.
