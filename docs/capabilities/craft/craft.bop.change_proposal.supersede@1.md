# craft.bop.change_proposal.supersede@1

craft.bop.change_proposal.supersede

## 使用判断

- 适用：craft.bop.change_proposal.supersede
...
资源选择器：
- `craft-bop-proposal` ← `proposal_gid`（必填）
...
```json
{
  "capability_id": "craft.bop.change_proposal.supersede",
