# craft.bop.entry.change.apply@1

Update or soft-delete an active BOP main-tree entry with linked-entity and audit semantics.

## 使用判断

- 适用：A governed Craft consumer edits fields on, or removes, one active BOP entry.
