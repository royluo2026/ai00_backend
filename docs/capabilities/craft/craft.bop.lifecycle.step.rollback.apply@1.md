# craft.bop.lifecycle.step.rollback.apply@1

Rollback one BOP lifecycle checklist step and its governed data effects.

## 使用判断

- 适用：A governed Craft consumer explicitly rolls back one supported lifecycle checklist step.
