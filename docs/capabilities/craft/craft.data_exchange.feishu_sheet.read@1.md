# craft.data_exchange.feishu_sheet.read@1

Read feishu_sheet read using owned immutable artifacts or the authenticated Feishu delegation.

## 使用判断

- 适用：Read feishu_sheet read using owned immutable artifacts or the authenticated Feishu delegation.
...
```json
{
  "capability_id": "craft.data_exchange.feishu_sheet.read",
