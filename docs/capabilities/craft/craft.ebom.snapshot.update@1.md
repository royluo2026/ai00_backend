# craft.ebom.snapshot.update@1

Update PBOM snapshot metadata.

## 使用判断

- 适用：A governed consumer changes one PBOM snapshot metadata resource.
...
```json
{
  "capability_id": "craft.ebom.snapshot.update",
