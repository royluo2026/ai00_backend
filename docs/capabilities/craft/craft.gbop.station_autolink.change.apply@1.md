# craft.gbop.station_autolink.change.apply@1

Apply or undo governed station auto-link changes for a BOP version.

## 使用判断

- 适用：A governed Craft consumer applies or reverses station auto-link results.
