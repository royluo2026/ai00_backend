# craft.bop.change_proposal.create@1

craft.bop.change_proposal.create

## 使用判断

- 适用：craft.bop.change_proposal.create
...
```json
{
  "capability_id": "craft.bop.change_proposal.create",
  "catalog_release": "<catalog_release>",
  "major_version": 1,
  "payload": {
    "idempotency_key": "example",
    "personal_space_gid": "1",
    "personal_version_gid": "1",
    "repository_gid": "1",
    "team_base_version_gid": "1"
  }
}
```
