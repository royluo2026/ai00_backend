# craft.library.read@1

Read bounded Craft manufacturing resource library collections.

## 使用判断

- 适用：A governed consumer needs Craft tool, equipment, fixture, fastener or standard part-name records.
