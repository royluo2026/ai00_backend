# craft.rule.engine.evaluate@1

Evaluate a Craft CEL rule or audit a BOP version against Craft rules.

## 使用判断

- 适用：A governed consumer needs rule evaluation or bounded BOP rule audit.
