# craft.data_exchange.excel.export@1

Write excel export using owned immutable artifacts or the authenticated Feishu delegation.

## 使用判断

- 适用：Write excel export using owned immutable artifacts or the authenticated Feishu delegation.
...
```json
{
  "capability_id": "craft.data_exchange.excel.export",
