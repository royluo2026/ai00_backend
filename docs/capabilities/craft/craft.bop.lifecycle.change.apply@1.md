# craft.bop.lifecycle.change.apply@1

Apply bounded transactional BOP lifecycle metadata and PBOM diff-queue changes.

## 使用判断

- 适用：A governed Craft consumer updates PBOM matching statistics or regenerates/updates a diff queue.
