# craft.ebom.vpps_check.read@1

Run the bounded four-rule VPPS validation projection for a PBOM snapshot.

## 使用判断

- 适用：A governed Craft consumer needs deterministic VPPS validation results for one snapshot.
