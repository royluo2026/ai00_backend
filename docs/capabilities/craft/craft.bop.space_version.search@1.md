# craft.bop.space_version.search@1

craft.bop.space_version.search

## 使用判断

- 适用：craft.bop.space_version.search
...
```json
{
  "capability_id": "craft.bop.space_version.search",
