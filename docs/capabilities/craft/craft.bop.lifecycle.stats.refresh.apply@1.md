# craft.bop.lifecycle.stats.refresh.apply@1

Recompute and persist the current BOP lifecycle statistics snapshot.

## 使用判断

- 适用：A governed Craft consumer explicitly requests a fresh lifecycle metrics snapshot.
