# craft.bop.linked_entity.detail.get@1

Read one allowlisted linked-entity card through its BOP link identity.

## 使用判断

- 适用：A consumer has a BOP link GID and needs its governed entity card.
