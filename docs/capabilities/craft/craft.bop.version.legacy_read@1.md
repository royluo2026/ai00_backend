# craft.bop.version.legacy_read@1

Read bounded legacy BOP version layout, tree and station-part projections.

## 使用判断

- 适用：A governed consumer still requires one of the legacy BOP version read projections.
