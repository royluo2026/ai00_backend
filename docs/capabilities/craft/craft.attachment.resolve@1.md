# craft.attachment.resolve@1

Resolve one historical attachment proven to belong to an authorized craft business parent into an immutable ArtifactRef.

## 使用判断

- 适用：Resolve one historical attachment proven to belong to an authorized craft business parent into an immutable ArtifactRef.
