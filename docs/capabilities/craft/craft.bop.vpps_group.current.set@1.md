# craft.bop.vpps_group.current.set@1

Advance the VPPS current pointer with CAS.

## 使用判断

- 适用：Advance the VPPS current pointer with CAS.
...
```json
{
  "capability_id": "craft.bop.vpps_group.current.set",
