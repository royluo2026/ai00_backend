# craft.data_exchange.feishu_sheet.write@1

Write feishu_sheet write using owned immutable artifacts or the authenticated Feishu delegation.

## 使用判断

- 适用：Write feishu_sheet write using owned immutable artifacts or the authenticated Feishu delegation.
...
```json
{
  "capability_id": "craft.data_exchange.feishu_sheet.write",
