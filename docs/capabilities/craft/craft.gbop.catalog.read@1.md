# craft.gbop.catalog.read@1

Read bounded GBOP entries, processes, operations and entry links.

## 使用判断

- 适用：A governed consumer needs GBOP catalog state for a specific version or entry.
