# craft.bop.entry_link.change.apply@1

Attach or detach a governed BOP entry link.

## 使用判断

- 适用：A Craft consumer changes the relationship between a BOP entry and a linked entity.
