# craft.gbop.navigation.change.apply@1

Confirm or execute bounded GBOP/PBOM navigation auto-link changes.

## 使用判断

- 适用：A governed Craft consumer confirms or runs the PBOM-to-GBOP auto-link workflow.
