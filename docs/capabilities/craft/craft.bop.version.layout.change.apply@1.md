# craft.bop.version.layout.change.apply@1

Update the bounded shared layout configuration for a BOP version.

## 使用判断

- 适用：A governed Craft consumer changes a BOP version's shared canvas layout metadata.
