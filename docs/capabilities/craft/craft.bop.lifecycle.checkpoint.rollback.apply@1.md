# craft.bop.lifecycle.checkpoint.rollback.apply@1

Restore a BOP line subtree and links from a selected checkpoint snapshot.

## 使用判断

- 适用：A governed Craft consumer explicitly restores one line to a checkpoint.
