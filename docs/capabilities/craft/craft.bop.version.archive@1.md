# craft.bop.version.archive@1

Archive a BOP version without deleting its snapshot or references.

## 使用判断

- 适用：Archive a BOP version without deleting its snapshot or references.
