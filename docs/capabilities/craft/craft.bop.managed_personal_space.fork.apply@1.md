# craft.bop.managed_personal_space.fork.apply@1

craft.bop.managed_personal_space.fork.apply

## 使用判断

- 适用：craft.bop.managed_personal_space.fork.apply
...
```json
{
  "capability_id": "craft.bop.managed_personal_space.fork.apply",
