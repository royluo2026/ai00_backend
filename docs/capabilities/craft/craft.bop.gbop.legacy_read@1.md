# craft.bop.gbop.legacy_read@1

Read legacy GBOP matching previews and ready PBOM version choices.

## 使用判断

- 适用：A governed Craft consumer needs the legacy GBOP match preview or PBOM version selector.
