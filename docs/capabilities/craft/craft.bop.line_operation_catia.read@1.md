# craft.bop.line_operation_catia.read@1

Read bounded operation CATIA occurrence names below one BOP line entry.

## 使用判断

- 适用：A governed consumer needs operation-level CATIA occurrence names for one BOP line.
