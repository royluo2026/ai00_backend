# craft.bop.entry.bulk.change.apply@1

Create, import, copy, auto-link, purge, patch, or rollback BOP entries through one governed change boundary.

## 使用判断

- 适用：A governed Craft consumer performs a multi-entry or entry-history mutation.
