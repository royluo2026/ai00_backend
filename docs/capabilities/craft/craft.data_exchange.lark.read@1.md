# craft.data_exchange.lark.read@1

Read bounded Lark Sheets or Bitable tabular data.

## 使用判断

- 适用：A governed Craft consumer reads a user-authorized Lark data source.
