# craft.bop.repository_diff.start@1

craft.bop.repository_diff.start

## 使用判断

- 适用：craft.bop.repository_diff.start
...
```json
{
  "capability_id": "craft.bop.repository_diff.start",
