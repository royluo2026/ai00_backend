# craft.vpps_audit.change.apply@1

Apply governed PBOM VPPS operation audit changes.

## 使用判断

- 适用：A governed consumer needs to bulk-ignore Rule4 rows or revert an audit operation.
