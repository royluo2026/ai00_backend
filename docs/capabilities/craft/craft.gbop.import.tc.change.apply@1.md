# craft.gbop.import.tc.change.apply@1

Import a bounded Teamcenter Excel workbook into a GBOP version.

## 使用判断

- 适用：A governed Craft consumer imports a validated Teamcenter workbook into an editable GBOP version.
