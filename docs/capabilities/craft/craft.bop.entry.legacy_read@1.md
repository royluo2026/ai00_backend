# craft.bop.entry.legacy_read@1

Read bounded legacy BOP entry links, PBOM projections, auto-link previews and history.

## 使用判断

- 适用：A governed Craft consumer still needs one of the supported legacy BOP entry read projections.
