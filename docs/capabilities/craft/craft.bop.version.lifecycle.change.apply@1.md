# craft.bop.version.lifecycle.change.apply@1

Publish a BOP version or archive/unarchive a BOP version family.

## 使用判断

- 适用：A governed Craft consumer changes BOP version publication or family archival state.
