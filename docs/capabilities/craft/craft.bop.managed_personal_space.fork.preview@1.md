# craft.bop.managed_personal_space.fork.preview@1

craft.bop.managed_personal_space.fork.preview

## 使用判断

- 适用：craft.bop.managed_personal_space.fork.preview
...
```json
{
  "capability_id": "craft.bop.managed_personal_space.fork.preview",
  "catalog_release": "<catalog_release>",
  "major_version": 1,
  "payload": {
    "expected_target_slot": 0,
    "fork_depth": "all",
