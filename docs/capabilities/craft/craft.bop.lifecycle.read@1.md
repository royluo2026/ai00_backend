# craft.bop.lifecycle.read@1

Read bounded BOP lifecycle history, checkpoints and operation logs.

## 使用判断

- 适用：A governed consumer needs lifecycle audit projections for a BOP version or line.
