# craft.bop.template.change.apply@1

Create a BOP template from a version or refresh a template from a source version.

## 使用判断

- 适用：A governed Craft consumer explicitly creates or refreshes a BOP template.
