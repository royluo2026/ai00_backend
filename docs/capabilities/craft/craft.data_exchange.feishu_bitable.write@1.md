# craft.data_exchange.feishu_bitable.write@1

Write feishu_bitable write using owned immutable artifacts or the authenticated Feishu delegation.

## 使用判断

- 适用：Write feishu_bitable write using owned immutable artifacts or the authenticated Feishu delegation.
...
```json
{
  "capability_id": "craft.data_exchange.feishu_bitable.write",
