# craft.bop.lifecycle.history.change.apply@1

Undo or redo one governed BOP line operation-history batch.

## 使用判断

- 适用：A governed Craft consumer explicitly undoes or redoes the latest eligible line history batch.
