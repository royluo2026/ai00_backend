# craft.bop.managed_personal_space.sync.preview@1

craft.bop.managed_personal_space.sync.preview

## 使用判断

- 适用：craft.bop.managed_personal_space.sync.preview
...
```json
{
  ...
  "properties": {
    ...
    "current_team_head_gid": {
      "pattern": "^[1-9][0-9]*$",
      "type": "string"
    },
    "recorded_team_head_gid": {
      "pattern": "^[1-9][0-9]*$",
      "type": "string"
    }
  },
...
```json
{
  "capability_id": "craft.bop.managed_personal_space.sync.preview",
  "catalog_release": "<catalog_release>",
  "major_version": 1,
  "payload": {
    "base_version_gid": "1",
    "current_team_head_gid": "1",
    "recorded_team_head_gid": "1"
  }
}
```
