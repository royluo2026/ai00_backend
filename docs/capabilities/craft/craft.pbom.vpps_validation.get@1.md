# craft.pbom.vpps_validation.get@1

Runs the four VPPS validation rules for one authenticated-readable Craft PBOM snapshot and returns bounded errors and concessions.

## 使用判断

- 适用：Runs the four VPPS validation rules for one authenticated-readable Craft PBOM snapshot and returns bounded errors and concessions.
