# craft.bop.lifecycle.state.read@1

Read the bounded aggregate lifecycle state for one BOP version.

## 使用判断

- 适用：A governed consumer needs the lifecycle dashboard projection for one BOP version.
