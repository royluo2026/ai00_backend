# craft.data_exchange.excel.parse@1

Read excel parse using owned immutable artifacts or the authenticated Feishu delegation.

## 使用判断

- 适用：Read excel parse using owned immutable artifacts or the authenticated Feishu delegation.
...
```json
{
  "capability_id": "craft.data_exchange.excel.parse",
