# craft.rule.library.change.apply@1

Apply bounded Craft rule-library CRUD changes.

## 使用判断

- 适用：A governed consumer needs to create, update or delete a Craft rule definition.
