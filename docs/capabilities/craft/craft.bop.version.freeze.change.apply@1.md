# craft.bop.version.freeze.change.apply@1

Freeze an active BOP version with link snapshots or unfreeze a baseline version.

## 使用判断

- 适用：A governed Craft consumer changes a BOP version's frozen baseline state.
