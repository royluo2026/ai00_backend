# craft.data_exchange.diff_report.export@1

Write diff_report export using owned immutable artifacts or the authenticated Feishu delegation.

## 使用判断

- 适用：Write diff_report export using owned immutable artifacts or the authenticated Feishu delegation.
...
```json
{
  "capability_id": "craft.data_exchange.diff_report.export",
