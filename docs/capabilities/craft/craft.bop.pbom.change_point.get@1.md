# craft.bop.pbom.change_point.get@1

Compare current and parent PBOM snapshots for a BOP version.

## 使用判断

- 适用：A governed consumer needs PBOM change points for a BOP version.
