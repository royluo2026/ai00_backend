# craft.bop.fork.change.apply@1

Fork, smart-fork, or stage-advance a BOP version with governed copy semantics.

## 使用判断

- 适用：A governed Craft consumer explicitly creates a derived BOP version from a source version.
