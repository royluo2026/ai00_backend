# craft.bop.picture.resolve@1

Read craft bop picture resolve using owned immutable artifacts or the authenticated Feishu delegation.

## 使用判断

- 适用：Read craft bop picture resolve using owned immutable artifacts or the authenticated Feishu delegation.
...
```json
{
  "capability_id": "craft.bop.picture.resolve",
