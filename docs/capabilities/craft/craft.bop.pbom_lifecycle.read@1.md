# craft.bop.pbom_lifecycle.read@1

Read bounded PBOM link statistics and diff queue projections for a BOP version.

## 使用判断

- 适用：A governed consumer needs PBOM matching status or the read-only diff queue.
