# craft.bop.change_proposal.withdraw@1

craft.bop.change_proposal.withdraw

## 使用判断

- 适用：craft.bop.change_proposal.withdraw
...
```json
{
  "capability_id": "craft.bop.change_proposal.withdraw",
