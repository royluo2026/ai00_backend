# craft.gbop.process_hierarchy.read@1

Read the bounded GBOP process-operation-part hierarchy for a PBOM version.

## 使用判断

- 适用：A governed consumer needs the GBOP process hierarchy and confirmed PBOM part bindings.
