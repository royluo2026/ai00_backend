# craft.resource_requirement.staging.search@1

Governed Craft resource requirement staging.search outcome.
...
```json
{
  "capability_id": "craft.resource_requirement.staging.search",
