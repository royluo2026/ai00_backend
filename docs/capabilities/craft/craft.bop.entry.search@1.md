# craft.bop.entry.search@1

Search bounded non-deleted BOP entries by title and node type.

## 使用判断

- 适用：A governed consumer needs to find BOP entries before selecting a detail or structure capability.
