# craft.gbop.import.change.apply@1

Import bounded VPPS parts or parsed entries into a GBOP version.

## 使用判断

- 适用：A governed Craft consumer imports validated VPPS or entry rows into an editable GBOP version.
