# craft.rule.definition.change.apply@1

Apply one closed, revision-pinned Craft rule definition change.

## 使用判断

- 适用：A governed consumer changes an owned Craft rule definition.
