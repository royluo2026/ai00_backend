# craft.bop.vpps_group.adjustment.create@1

Create an immutable ordered VPPS adjustment.

## 使用判断

- 适用：Create an immutable ordered VPPS adjustment.
...
```json
{
  "capability_id": "craft.bop.vpps_group.adjustment.create",
