# craft.bop.repository_baseline.set@1

craft.bop.repository_baseline.set

## 使用判断

- 适用：craft.bop.repository_baseline.set
...
资源选择器：
- `craft-bop-repository` ← `repository_gid`（必填）
...
```json
{
  "capability_id": "craft.bop.repository_baseline.set",
