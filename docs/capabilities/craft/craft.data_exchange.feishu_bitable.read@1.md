# craft.data_exchange.feishu_bitable.read@1

Read feishu_bitable read using owned immutable artifacts or the authenticated Feishu delegation.

## 使用判断

- 适用：Read feishu_bitable read using owned immutable artifacts or the authenticated Feishu delegation.
...
```json
{
  "capability_id": "craft.data_exchange.feishu_bitable.read",
