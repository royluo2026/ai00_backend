# craft.ebom.legacy_read@1

Read bounded legacy PBOM snapshot comparison projections.

## 使用判断

- 适用：A governed Craft consumer needs the legacy eBOM/PBOM diff response shape.
