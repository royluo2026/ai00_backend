# craft.bop.picture.upload@1

Upload a bounded image asset for BOP picture references.

## 使用判断

- 适用：A governed Craft consumer uploads an image used by a BOP entry or process view.
