# craft.bop.staging.lifecycle.change.apply@1

Promote a BOP staging item into the main tree or demote an entry into staging.

## 使用判断

- 适用：A governed Craft consumer moves a BOP entry between staging and the active tree.
