# craft.bop.managed_personal_space.import.apply@1

craft.bop.managed_personal_space.import.apply

## 使用判断

- 适用：craft.bop.managed_personal_space.import.apply
...
资源选择器：
- `craft-bop-space` ← `personal_space_gid`（必填）
...
```json
{
  "capability_id": "craft.bop.managed_personal_space.import.apply",
  "catalog_release": "<catalog_release>",
  "major_version": 1,
  "payload": {
    "expected_personal_head": 1,
    "export_ref": "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx",
    "idempotency_key": "example",
    "personal_space_gid": "1",
    "preview_gid": "1",
    "repository_gid": "1",
    "selected_units": []
  }
