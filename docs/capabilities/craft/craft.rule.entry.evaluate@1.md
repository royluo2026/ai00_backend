# craft.rule.entry.evaluate@1

Evaluate one visible Craft rule against a bounded entry projection.

## 使用判断

- 适用：A governed consumer needs a revision-pinned Craft rule decision for one entry.
