# craft.bop.import.preview@1

Parse and hash a BOP import document without mutating Craft state.

## 使用判断

- 适用：Parse and hash a BOP import document without mutating Craft state.
