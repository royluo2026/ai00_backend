# craft.bop.lifecycle.state.change.apply@1

Update BOP lifecycle initialization state or confirm and advance its current phase.

## 使用判断

- 适用：A governed Craft consumer changes initialization checklist/route or confirms the current lifecycle phase.
