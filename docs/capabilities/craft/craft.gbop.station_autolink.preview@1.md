# craft.gbop.station_autolink.preview@1

Preview bounded BOP station auto-link candidates without mutating bindings.

## 使用判断

- 适用：A governed Craft consumer needs to inspect station/process auto-link candidates.
