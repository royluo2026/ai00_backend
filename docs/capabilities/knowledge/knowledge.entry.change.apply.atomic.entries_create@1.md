# knowledge.entry.change.apply.atomic.entries_create@1

Execute Knowledge operation entries.create.
...
```json
{
  "capability_id": "knowledge.entry.change.apply.atomic.entries_create",
