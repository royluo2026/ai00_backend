# knowledge.entry.change.apply.atomic.entries_update@1

Execute Knowledge operation entries.update.
...
```json
{
  "capability_id": "knowledge.entry.change.apply.atomic.entries_update",
