# knowledge.space.change.apply.atomic.spaces_archive@1

Execute Knowledge operation spaces.archive.
...
```json
{
  "capability_id": "knowledge.space.change.apply.atomic.spaces_archive",
