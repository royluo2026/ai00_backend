# knowledge.document.archive.atomic.documents_archive@1

Execute Knowledge operation documents.archive.
...
```json
{
  "capability_id": "knowledge.document.archive.atomic.documents_archive",
