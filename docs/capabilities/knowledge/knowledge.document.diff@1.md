# knowledge.document.diff@1

Diff two immutable Markdown revisions.

## 使用判断

- 适用：A caller needs exact changes between revisions.
...
```json
{
  ...
  "payload": {
    ...
    "from_revision_gid": "example",
    "to_revision_gid": "example"
  }
}
```
