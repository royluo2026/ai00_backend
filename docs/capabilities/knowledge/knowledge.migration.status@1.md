# knowledge.migration.status@1

Inspect tenant-safe legacy Markdown migration readiness and audited runs.

## 使用判断

- 适用：Inspect tenant-safe legacy Markdown migration readiness and audited runs.
