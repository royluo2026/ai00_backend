# knowledge.document.create@1

Create a published Markdown document revision in immutable OIS storage.

## 使用判断

- 适用：A new knowledge document is required.
