# knowledge.personalization.change.apply.atomic.favorites_toggle@1

Execute Knowledge operation favorites.toggle.
...
- 授权策略：`knowledge.v2:knowledge.write`
- 自动化等级：`A1`
- 数据分类：`confidential`
- Delegation：`scoped`
- 认证新鲜度：0 秒
...
```json
{
  "capability_id": "knowledge.personalization.change.apply.atomic.favorites_toggle",
