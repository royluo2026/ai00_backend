# knowledge.entry.change.apply.atomic.entries_delete@1

Execute Knowledge operation entries.delete.
...
```json
{
  "capability_id": "knowledge.entry.change.apply.atomic.entries_delete",
