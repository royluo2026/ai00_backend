# knowledge.document.revisions@1

Deprecated compatibility alias for knowledge.document.history.get.

## 使用判断

- 适用：Migrating a legacy internal consumer.
