# knowledge.context.retrieve@1

Retrieve bounded immutable Knowledge revision references for one task.

## 使用判断

- 适用：A person or model needs decision context, not whole documents.
