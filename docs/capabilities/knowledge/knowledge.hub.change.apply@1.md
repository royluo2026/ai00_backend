# knowledge.hub.change.apply@1

Execute knowledge.hub.change.apply.

## 使用判断

- 适用：A governed consumer needs this Knowledge outcome.
...
```json
{
  "capability_id": "knowledge.hub.change.apply",
