# knowledge.personalization.read.atomic.recent_list@1

Execute Knowledge operation recent.list.
...
```json
{
  "capability_id": "knowledge.personalization.read.atomic.recent_list",
