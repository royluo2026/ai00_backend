# knowledge.hub.change.apply.atomic.folders_update@1

Execute Knowledge operation folders.update.
...
```json
{
  "capability_id": "knowledge.hub.change.apply.atomic.folders_update",
