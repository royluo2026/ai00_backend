# integration.connector.update@1

Execute the governed integration.connector.update Integration outcome.
...
- 授权策略：`integration.v2:integration.write`
- 自动化等级：`A1`
- 数据分类：`confidential`
- Delegation：`scoped`
- 认证新鲜度：0 秒
...
```json
{
  "capability_id": "integration.connector.update",
