# integration.field_mapping.search@1

Execute the governed integration.field_mapping.search Integration outcome.
...
```json
{
  "capability_id": "integration.field_mapping.search",
