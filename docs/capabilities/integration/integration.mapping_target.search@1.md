# integration.mapping_target.search@1

Execute the governed integration.mapping_target.search Integration outcome.
...
- 授权策略：`integration.v2:integration.read`
- 自动化等级：`A2`
- 数据分类：`confidential`
- Delegation：`scoped`
- 认证新鲜度：0 秒
...
```json
{
  "capability_id": "integration.mapping_target.search",
