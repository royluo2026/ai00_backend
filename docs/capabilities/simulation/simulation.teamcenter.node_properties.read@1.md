...
Read the fixed display-property projection for one exact Teamcenter occurrence, using the principal-scoped local cache first.
...
```json
{
  "capability_id": "simulation.teamcenter.node_properties.read",
