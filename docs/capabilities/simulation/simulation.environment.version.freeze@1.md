...
Freeze one private simulation workspace version as an immutable Base Artifact.

## 使用判断

- 适用：Freeze one private simulation workspace version as an immutable Base Artifact.
...
```json
{
  "capability_id": "simulation.environment.version.freeze",
