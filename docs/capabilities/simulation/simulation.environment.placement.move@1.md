...
Move one placement without copying its source model.

## 使用判断

- 适用：Move one placement without copying its source model.
...
```json
{
  "capability_id": "simulation.environment.placement.move",
