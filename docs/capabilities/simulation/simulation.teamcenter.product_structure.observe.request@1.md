...
Queue one bounded read-only Teamcenter product-structure observation on the App workstation.
...
```json
{
  "capability_id": "simulation.teamcenter.product_structure.observe.request",
  "catalog_release": "<catalog_release>",
  "major_version": 1,
  "payload": {
    "max_depth": 1,
    "max_nodes": 1,
    "property_projection": "example",
    "source_selector": {
