# simulation.environment.online_source.bind@1

Bind one immutable Teamcenter online selector as a model instance in a Simulation environment.

## 使用判断

- 适用：Bind one immutable Teamcenter online selector as a model instance in a Simulation environment.
...
```json
{
  "capability_id": "simulation.environment.online_source.bind",
  "catalog_release": "<catalog_release>",
  "major_version": 1,
  "payload": {
    "display_name": "example",
    "expected_row_version": 1,
    "insertion_instance_id": "example",
    "source_selector": {
