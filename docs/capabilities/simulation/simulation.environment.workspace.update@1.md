# simulation.environment.workspace.update@1

Update metadata of one owner-controlled simulation workspace.

## 使用判断

- 适用：Update metadata of one owner-controlled simulation workspace.
...
```json
{
  "capability_id": "simulation.environment.workspace.update",
  ...
  "payload": {
    ...
    "name": "example",
    "primary_project_gid": "1",
    "project_gids": [],
    "review_type": "node_review",
    "status": "active",
