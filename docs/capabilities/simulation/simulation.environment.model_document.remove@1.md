...
Soft-remove one model document from an owned Simulation environment.

## 使用判断

- 适用：Soft-remove one model document from an owned Simulation environment.
...
```json
{
  "capability_id": "simulation.environment.model_document.remove",
