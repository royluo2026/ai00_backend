...
Read authoritative progress and the confirmed active VisMockup BOM snapshot.

## 使用判断

- 适用：Read authoritative progress and the confirmed active VisMockup BOM snapshot.
...
```json
{
  "capability_id": "simulation.document_snapshot.get",
