# simulation.environment.structure_node.move@1

Move one node in a private simulation workspace.

## 使用判断

- 适用：Move one node in a private simulation workspace.
...
```json
{
  "capability_id": "simulation.environment.structure_node.move",
