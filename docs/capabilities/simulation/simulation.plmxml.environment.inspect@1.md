# simulation.plmxml.environment.inspect@1

Inspect one immutable PLMXML Artifact and return selectable model and alternate-hierarchy projections without mutating an environment.

## 使用判断

- 适用：Inspect one immutable PLMXML Artifact and return selectable model and alternate-hierarchy projections without mutating an environment.
...
```json
{
  "capability_id": "simulation.plmxml.environment.inspect",
