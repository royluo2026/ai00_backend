# simulation.connector_document_snapshot_outcome.apply@1

Project one authenticated Connector document snapshot outcome into its exact Simulation request.

## 使用判断

- 适用：Project one authenticated Connector document snapshot outcome into its exact Simulation request.
