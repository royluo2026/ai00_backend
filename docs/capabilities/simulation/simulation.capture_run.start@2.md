...
Prepare reverse-order internal VisMockup captures for separately confirmed dispatch.

## 使用判断

- 适用：Prepare reverse-order internal VisMockup captures for separately confirmed dispatch.
