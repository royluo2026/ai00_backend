...
Search caller-visible personal and shared VM checkpoints.

## 使用判断

- 适用：Search caller-visible personal and shared VM checkpoints.
...
```json
{
  "capability_id": "simulation.vm_checkpoint.search",
