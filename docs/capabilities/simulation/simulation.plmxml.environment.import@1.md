...
Import one immutable primary or supplemental PLMXML Artifact into an owned draft environment.

## 使用判断

- 适用：Import one immutable primary or supplemental PLMXML Artifact into an owned draft environment.
...
```json
{
  "capability_id": "simulation.plmxml.environment.import",
