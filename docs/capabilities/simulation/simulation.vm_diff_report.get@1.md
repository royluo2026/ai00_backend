...
Read one caller-visible immutable VM difference report summary.

## 使用判断

- 适用：Read one caller-visible immutable VM difference report summary.
...
```json
{
  "capability_id": "simulation.vm_diff_report.get",
