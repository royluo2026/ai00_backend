...
Rename one owned alternate hierarchy with optimistic concurrency.

## 使用判断

- 适用：Rename one owned alternate hierarchy with optimistic concurrency.
...
```json
{
  "capability_id": "simulation.environment.alternate_hierarchy.update",
