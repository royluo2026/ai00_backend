...
Prepare an immutable active VisMockup BOM snapshot for separately confirmed dispatch.

## 使用判断

- 适用：Prepare an immutable active VisMockup BOM snapshot for separately confirmed dispatch.
