...
Read the exact materialization action awaiting user confirmation.

## 使用判断

- 适用：Read the exact materialization action awaiting user confirmation.
...
```json
{
  "capability_id": "simulation.materialization_run.action.get",
