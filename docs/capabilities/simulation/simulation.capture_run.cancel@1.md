...
Cancel unstarted capture steps and reconcile active work.

## 使用判断

- 适用：Cancel unstarted capture steps and reconcile active work.
...
```json
{
  "capability_id": "simulation.capture_run.cancel",
