# simulation.environment.structure_node.create@1

Create one node in a private simulation workspace.

## 使用判断

- 适用：Create one node in a private simulation workspace.
...
```json
{
  "capability_id": "simulation.environment.structure_node.create",
