...
Search model documents in one readable Simulation environment.

## 使用判断

- 适用：Search model documents in one readable Simulation environment.
...
```json
{
  "capability_id": "simulation.environment.model_document.search",
