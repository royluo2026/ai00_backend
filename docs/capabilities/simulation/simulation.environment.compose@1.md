...
Compose an immutable Connector environment from pinned owning-domain sources.

## 使用判断

- 适用：Compose an immutable Connector environment from pinned owning-domain sources.
