# simulation.environment.alternate_hierarchy.bootstrap_from_bop_fork@1

Repairably bootstrap one editable alternate hierarchy from an immutable governed Craft fork projection.

## 使用判断

- 适用：Repairably bootstrap one editable alternate hierarchy from an immutable governed Craft fork projection.
...
```json
{
  "capability_id": "simulation.environment.alternate_hierarchy.bootstrap_from_bop_fork",
