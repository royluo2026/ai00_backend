...
Remove one VM occurrence binding from a simulation workspace.

## 使用判断

- 适用：Remove one VM occurrence binding from a simulation workspace.
...
```json
{
  "capability_id": "simulation.environment.binding.remove",
