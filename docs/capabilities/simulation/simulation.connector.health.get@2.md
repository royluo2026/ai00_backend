...
Read the bound Simulation workstation runtime and adapter health.

## 使用判断

- 适用：A Simulation workflow preflights a bound desktop runtime.
...
资源选择器：
- `simulation-connector` ← `connector_id`（必填）
