# simulation.environment.workspace.fork.apply@1

Apply a validated private workspace Fork without mutating its immutable source.

## 使用判断

- 适用：Apply a validated private workspace Fork without mutating its immutable source.
...
```json
{
  "capability_id": "simulation.environment.workspace.fork.apply",
