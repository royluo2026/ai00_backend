# simulation.environment.workspace.delete@1

Logically delete one owner-controlled simulation workspace.

## 使用判断

- 适用：Logically delete one owner-controlled simulation workspace.
...
```json
{
  "capability_id": "simulation.environment.workspace.delete",
