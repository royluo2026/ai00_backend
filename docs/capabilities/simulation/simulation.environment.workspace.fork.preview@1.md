# simulation.environment.workspace.fork.preview@1

Preview a private workspace Fork from an immutable readable version.

## 使用判断

- 适用：Preview a private workspace Fork from an immutable readable version.
...
资源选择器：
- `simulation-workspace` ← `source_workspace_gid`（必填）
...
```json
{
  "capability_id": "simulation.environment.workspace.fork.preview",
  "catalog_release": "<catalog_release>",
  "major_version": 1,
  "payload": {
    "fork_depth": "all",
    "source_version_gid": "1",
    "source_workspace_gid": "1",
    "target_name": "example",
    "target_version_label": "example"
  }
}
```
