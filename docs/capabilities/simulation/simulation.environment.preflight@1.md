...
Check exact Connector and VisMockup compatibility without queuing work.

## 使用判断

- 适用：Check exact Connector and VisMockup compatibility without queuing work.
...
```json
{
  "capability_id": "simulation.environment.preflight",
