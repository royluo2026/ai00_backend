# simulation.product_structure.observation.begin@1

Start an append-only product-structure observation manifest.

## 使用判断

- 适用：Start an append-only product-structure observation manifest.
...
```json
{
  "capability_id": "simulation.product_structure.observation.begin",
