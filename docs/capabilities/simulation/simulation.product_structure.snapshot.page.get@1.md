# simulation.product_structure.snapshot.page.get@1

Read one bounded page from a published product-structure snapshot.

## 使用判断

- 适用：Read one bounded page from a published product-structure snapshot.
...
```json
{
  "capability_id": "simulation.product_structure.snapshot.page.get",
