...
Persist one signed bounded alternate-hierarchy inventory page into its bound environment.
...
```json
{
  "capability_id": "simulation.environment.live_document.inventory.apply",
  "catalog_release": "<catalog_release>",
  "major_version": 1,
  "payload": {
    "idempotency_key": "example",
    "inventory_operation_id": "example",
    "workspace_gid": "1"
  }
}
```
