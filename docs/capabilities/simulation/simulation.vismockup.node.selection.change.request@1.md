...
Queue a signed request to change one tree node's selection highlight in the active VisMockup document.
...
```json
{
  "capability_id": "simulation.vismockup.node.selection.change.request",
