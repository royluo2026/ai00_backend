...
Queue one bounded page read from an existing local Teamcenter structure observation.
...
```json
{
  "capability_id": "simulation.teamcenter.product_structure.page.read.request",
