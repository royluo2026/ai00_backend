...
Retry one proven-failed capture step with a new attempt.

## 使用判断

- 适用：Retry one proven-failed capture step with a new attempt.
...
```json
{
  "capability_id": "simulation.capture_step.retry",
