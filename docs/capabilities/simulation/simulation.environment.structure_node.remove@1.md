# simulation.environment.structure_node.remove@1

Soft-delete one simulation workspace subtree.

## 使用判断

- 适用：Soft-delete one simulation workspace subtree.
...
```json
{
  "capability_id": "simulation.environment.structure_node.remove",
