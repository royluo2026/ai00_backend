...
Read the exact next downstream action awaiting user confirmation.

## 使用判断

- 适用：Read the exact next downstream action awaiting user confirmation.
...
```json
{
  "capability_id": "simulation.capture_run.action.get",
