# simulation.product_structure.observation.page.append@1

Append one immutable page to a product-structure observation.

## 使用判断

- 适用：Append one immutable page to a product-structure observation.
...
```json
{
  "capability_id": "simulation.product_structure.observation.page.append",
