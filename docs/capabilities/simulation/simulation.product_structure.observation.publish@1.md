# simulation.product_structure.observation.publish@1

Validate and publish a complete immutable product-structure observation.

## 使用判断

- 适用：Validate and publish a complete immutable product-structure observation.
...
```json
{
  "capability_id": "simulation.product_structure.observation.publish",
