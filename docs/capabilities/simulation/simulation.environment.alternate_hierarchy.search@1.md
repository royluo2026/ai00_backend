...
Search editable alternate hierarchies in one readable environment.

## 使用判断

- 适用：Search editable alternate hierarchies in one readable environment.
...
```json
{
  "capability_id": "simulation.environment.alternate_hierarchy.search",
