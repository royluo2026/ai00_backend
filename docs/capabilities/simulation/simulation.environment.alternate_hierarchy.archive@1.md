...
Archive one owned alternate hierarchy and retain its audit history.

## 使用判断

- 适用：Archive one owned alternate hierarchy and retain its audit history.
...
```json
{
  "capability_id": "simulation.environment.alternate_hierarchy.archive",
