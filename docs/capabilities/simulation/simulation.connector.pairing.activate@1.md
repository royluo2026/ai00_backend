# simulation.connector.pairing.activate@1

A credentialed Connector acknowledges durable credential activation.

## 使用判断

- 适用：The Connector has persisted and verified its issued credential.
