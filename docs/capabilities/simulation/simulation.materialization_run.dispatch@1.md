...
Dispatch one prepared materialization action using its separate user confirmation.

## 使用判断

- 适用：Dispatch one prepared materialization action using its separate user confirmation.
