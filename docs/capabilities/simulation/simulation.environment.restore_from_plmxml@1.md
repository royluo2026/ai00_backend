# simulation.environment.restore_from_plmxml@1

Create one private draft Simulation environment from one inspected immutable PLMXML Artifact.

## 使用判断

- 适用：Create one private draft Simulation environment from one inspected immutable PLMXML Artifact.
...
```json
{
  "capability_id": "simulation.environment.restore_from_plmxml",
