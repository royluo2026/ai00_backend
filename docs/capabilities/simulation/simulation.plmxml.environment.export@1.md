...
Export one readable environment as an immutable deterministic PLMXML Artifact.

## 使用判断

- 适用：Export one readable environment as an immutable deterministic PLMXML Artifact.
...
```json
{
  "capability_id": "simulation.plmxml.environment.export",
