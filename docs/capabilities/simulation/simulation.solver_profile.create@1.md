# simulation.solver_profile.create@1

Create an immutable solver profile.

## 使用判断

- 适用：Create an immutable solver profile.
...
```json
{
  "capability_id": "simulation.solver_profile.create",
