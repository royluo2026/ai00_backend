...
Queue one read-only generation-pinned page of direct children for an exact Teamcenter source and occurrence path.
...
```json
{
  "capability_id": "simulation.teamcenter.product_structure.children.read.request",
