...
Create or reuse an importing environment and register its primary live VisMockup document.
...
```json
{
  "capability_id": "simulation.environment.live_document.adopt",
  "catalog_release": "<catalog_release>",
  "major_version": 2,
  "payload": {
    "document_display_name": "example",
