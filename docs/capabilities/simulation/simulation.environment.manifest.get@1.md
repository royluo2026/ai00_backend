# simulation.environment.manifest.get@1

Read one immutable Connector environment manifest.

## 使用判断

- 适用：Read one immutable Connector environment manifest.
...
```json
{
  "capability_id": "simulation.environment.manifest.get",
