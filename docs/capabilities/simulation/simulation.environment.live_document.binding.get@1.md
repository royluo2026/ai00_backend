...
Resolve the owner-scoped environment binding of a native document or selected environment.
...
```json
{
  "capability_id": "simulation.environment.live_document.binding.get",
