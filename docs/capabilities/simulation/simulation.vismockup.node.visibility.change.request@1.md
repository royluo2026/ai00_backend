...
Queue a signed request to change one tree node's visibility in the active VisMockup document.
...
```json
{
  "capability_id": "simulation.vismockup.node.visibility.change.request",
