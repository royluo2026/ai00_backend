...
Issue an owner-scoped reference to one immutable private workspace version.

## 使用判断

- 适用：Issue an owner-scoped reference to one immutable private workspace version.
...
```json
{
  ...
  "properties": {
    "consumer_capability_id": {
      "const": "craft.bop.managed_personal_space.import.preview",
      "type": "string"
    },
    "consumer_major_version": {
      "const": 1,
      "type": "integer"
    },
    "expires_in_seconds": {
...
```json
{
  "capability_id": "simulation.environment.workspace_version.export_for_import",
  "catalog_release": "<catalog_release>",
  "major_version": 1,
  "payload": {
    "consumer_capability_id": "craft.bop.managed_personal_space.import.preview",
    "consumer_major_version": 1,
    "expires_in_seconds": 60,
    "idempotency_key": "example",
    "target_personal_space_gid": "1",
    "target_repository_gid": "1",
    "version_gid": "1",
    "workspace_gid": "1"
  }
}
...
```json
{
  ...
  "properties": {
    "consumer": {
      "const": "craft.bop.managed_personal_space.import.preview@1",
      "type": "string"
    },
    "content_hash": {
