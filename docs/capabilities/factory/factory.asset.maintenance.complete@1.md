# factory.asset.maintenance.complete@1

Execute the governed factory.asset.maintenance.complete Factory outcome.
...
```json
{
  "capability_id": "factory.asset.maintenance.complete",
