# ontology.release.publish@1

Publish an approved proposal as a new immutable inactive release.

## 使用判断

- 适用：An exact proposal revision has independent approval.
...
- 授权策略：`ontology.v2:ontology.publish`
- 自动化等级：`A1`
- 数据分类：`confidential`
- Delegation：`scoped`
- 认证新鲜度：0 秒
