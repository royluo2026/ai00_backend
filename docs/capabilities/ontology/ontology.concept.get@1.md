# ontology.concept.get@1

Read a summary or schema view pinned to an immutable release.

## 使用判断

- 适用：A stable ontology identity is known.
