# ontology.change.proposal.create@2

Create an immutable typed proposal against the exact active release.

## 使用判断

- 适用：A governed ontology change is being proposed with structured values.
