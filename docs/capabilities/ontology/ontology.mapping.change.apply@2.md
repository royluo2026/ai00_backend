# ontology.mapping.change.apply@2

Convert a structured schema or mapping change into a governed Ontology proposal.

## 使用判断

- 适用：A consumer needs to propose a structured Ontology change.
...
```json
{
  "capability_id": "ontology.mapping.change.apply",
