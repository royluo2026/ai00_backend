# ontology.change.proposal.review.submit@1

Append a human review bound to an immutable proposal revision Hash.

## 使用判断

- 适用：A human reviewer makes a formal decision.
...
- 授权策略：`ontology.v2:ontology.review`
- 自动化等级：`A1`
- 数据分类：`confidential`
- Delegation：`scoped`
- 认证新鲜度：0 秒
