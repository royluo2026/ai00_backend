# agent.tool_catalog.list@1

Lists the finite tool descriptions shown in the Agent toolbox.

## 使用判断

- 适用：Lists the finite tool descriptions shown in the Agent toolbox.
...
```json
{
  "capability_id": "agent.tool_catalog.list",
