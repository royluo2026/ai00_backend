# agent.orchestration.binding.delete@1

Execute the governed agent.orchestration.binding.delete Agent outcome.
...
```json
{
  "capability_id": "agent.orchestration.binding.delete",
