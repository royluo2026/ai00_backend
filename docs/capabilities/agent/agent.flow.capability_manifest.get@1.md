# agent.flow.capability_manifest.get@1

Reports the retired legacy node palette and the requirement to select governed Catalog capabilities.

## 使用判断

- 适用：Reports the retired legacy node palette and the requirement to select governed Catalog capabilities.
...
```json
{
  "capability_id": "agent.flow.capability_manifest.get",
