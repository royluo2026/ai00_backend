# agent.orchestration.panorama.read@1

Execute the governed agent.orchestration.panorama.read Agent outcome.
...
```json
{
  "capability_id": "agent.orchestration.panorama.read",
