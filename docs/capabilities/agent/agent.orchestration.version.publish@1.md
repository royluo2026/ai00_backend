# agent.orchestration.version.publish@1

Execute the governed agent.orchestration.version.publish Agent outcome.
...
```json
{
  "capability_id": "agent.orchestration.version.publish",
