# agent.skill.update@1

Updates one owned Skill while preserving system Skill and global publishing restrictions.

## 使用判断

- 适用：Updates one owned Skill while preserving system Skill and global publishing restrictions.
...
```json
{
  "capability_id": "agent.skill.update",
