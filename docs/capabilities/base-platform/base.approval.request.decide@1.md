# base.approval.request.decide@1

Execute base.approval.request.decide in the Base Approval service.

## 使用判断

- 适用：Execute base.approval.request.decide in the Base Approval service.
