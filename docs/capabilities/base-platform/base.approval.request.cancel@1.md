# base.approval.request.cancel@1

Execute base.approval.request.cancel in the Base Approval service.

## 使用判断

- 适用：Execute base.approval.request.cancel in the Base Approval service.
...
- 授权策略：`base.v2:base.approval.write`
- 自动化等级：`A1`
- 数据分类：`confidential`
- Delegation：`scoped`
- 认证新鲜度：0 秒
