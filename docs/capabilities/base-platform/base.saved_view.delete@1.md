# base.saved_view.delete@1

Execute exact Base outcome base.saved_view.delete.
...
```json
{
  "capability_id": "base.saved_view.delete",
...
- `idempotency_conflict`：base.saved_view.delete can return idempotency_conflict.（retryable=false）
- `invalid_input`：base.saved_view.delete can return invalid_input.（retryable=false）
- `legacy_config_unsupported`：base.saved_view.delete can return legacy_config_unsupported.（retryable=false）
- `permission_denied`：base.saved_view.delete can return permission_denied.（retryable=false）
- `resource_not_found`：base.saved_view.delete can return resource_not_found.（retryable=false）
- `revision_conflict`：base.saved_view.delete can return revision_conflict.（retryable=false）
