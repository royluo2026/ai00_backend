# base.plugin.marketplace.release.change.apply@1

Execute the reviewed base.plugin.marketplace.release.change.apply Base outcome.

## 使用判断

- 适用：Execute the reviewed base.plugin.marketplace.release.change.apply Base outcome.
...
```json
{
  "capability_id": "base.plugin.marketplace.release.change.apply",
