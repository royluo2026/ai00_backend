# base.team.member.add@1

Assigns one existing or identified Feishu user to a team the administrator controls.

## 使用判断

- 适用：Assigns one existing or identified Feishu user to a team the administrator controls.
...
```json
{
  "capability_id": "base.team.member.add",
