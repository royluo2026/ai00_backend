# base.feishu.chat.search@1

Finds bounded matching Feishu chats available to the authenticated user.

## 使用判断

- 适用：Finds bounded matching Feishu chats available to the authenticated user.
...
```json
{
  "capability_id": "base.feishu.chat.search",
