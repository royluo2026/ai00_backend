# base.team.member.list@1

Returns at most 500 members of a team the current user may view.

## 使用判断

- 适用：Returns at most 500 members of a team the current user may view.
...
```json
{
  "capability_id": "base.team.member.list",
