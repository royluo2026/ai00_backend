# base.authorization.grant.read@1

Execute the reviewed base.authorization.grant.read Base outcome.

## 使用判断

- 适用：Execute the reviewed base.authorization.grant.read Base outcome.
...
```json
{
  "capability_id": "base.authorization.grant.read",
