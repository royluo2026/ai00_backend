# base.feishu.list_share.send@1

Sends one explicitly confirmed list link to the selected Feishu chat.

## 使用判断

- 适用：Sends one explicitly confirmed list link to the selected Feishu chat.
