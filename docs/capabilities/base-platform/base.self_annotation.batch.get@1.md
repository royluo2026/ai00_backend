# base.self_annotation.batch.get@1

Execute exact Base outcome base.self_annotation.batch.get.
...
```json
{
  "capability_id": "base.self_annotation.batch.get",
...
- `invalid_input`：base.self_annotation.batch.get can return invalid_input.（retryable=false）
