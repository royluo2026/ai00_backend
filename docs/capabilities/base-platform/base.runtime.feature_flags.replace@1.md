# base.runtime.feature_flags.replace@1

Replaces the typed UI feature configuration and invalidates the runtime cache.

## 使用判断

- 适用：Replaces the typed UI feature configuration and invalidates the runtime cache.
...
```json
{
  "capability_id": "base.runtime.feature_flags.replace",
