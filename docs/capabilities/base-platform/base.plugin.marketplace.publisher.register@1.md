# base.plugin.marketplace.publisher.register@1

Execute the reviewed base.plugin.marketplace.publisher.register Base outcome.

## 使用判断

- 适用：Execute the reviewed base.plugin.marketplace.publisher.register Base outcome.
