# base.file_store.ois_connection.test@1

Checks the configured OIS connection by writing the fixed connectivity probe object.

## 使用判断

- 适用：Checks the configured OIS connection by writing the fixed connectivity probe object.
...
```json
{
  "capability_id": "base.file_store.ois_connection.test",
