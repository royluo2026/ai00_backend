# base.feishu.organization_user.search@1

Finds up to 15 Feishu users and identifies their existing Base registrations.

## 使用判断

- 适用：Finds up to 15 Feishu users and identifies their existing Base registrations.
...
```json
{
  "capability_id": "base.feishu.organization_user.search",
