# base.runtime.database_config.change.apply@1

Save runtime database configuration without exposing stored credentials.

## 使用判断

- 适用：A super administrator manages the server runtime database connection.
