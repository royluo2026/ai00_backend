# base.plugin.marketplace.search@1

Execute the reviewed base.plugin.marketplace.search Base outcome.

## 使用判断

- 适用：Execute the reviewed base.plugin.marketplace.search Base outcome.
...
```json
{
  "capability_id": "base.plugin.marketplace.search",
