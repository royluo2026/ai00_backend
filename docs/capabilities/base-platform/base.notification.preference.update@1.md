...
Execute base.notification.preference.update in the Base collaboration service.

## 使用判断

- 适用：Execute base.notification.preference.update in the Base collaboration service.
