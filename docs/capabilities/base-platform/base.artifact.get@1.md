...
Authorizes one immutable artifact for Main preview or native download.

## 使用判断

- 适用：Authorizes one immutable artifact for Main preview or native download.
...
```json
{
  "capability_id": "base.artifact.get",
