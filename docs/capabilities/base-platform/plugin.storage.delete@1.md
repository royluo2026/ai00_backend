# plugin.storage.delete@1

Delete a value using optional optimistic versioning.

## 使用判断

- 适用：Delete a value using optional optimistic versioning.
...
```json
{
  "capability_id": "plugin.storage.delete",
