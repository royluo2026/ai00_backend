# base.file_store.minio_config.set@1

Saves the explicit MinIO connection settings and reinitializes storage.

## 使用判断

- 适用：Saves the explicit MinIO connection settings and reinitializes storage.
...
```json
{
  "capability_id": "base.file_store.minio_config.set",
