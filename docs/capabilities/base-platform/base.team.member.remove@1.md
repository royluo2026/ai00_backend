# base.team.member.remove@1

Removes one member from a team the administrator controls.

## 使用判断

- 适用：Removes one member from a team the administrator controls.
...
```json
{
  "capability_id": "base.team.member.remove",
