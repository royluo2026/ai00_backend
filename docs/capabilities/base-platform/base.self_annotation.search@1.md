# base.self_annotation.search@1

Execute exact Base outcome base.self_annotation.search.
...
```json
{
  "capability_id": "base.self_annotation.search",
...
- `invalid_input`：base.self_annotation.search can return invalid_input.（retryable=false）
