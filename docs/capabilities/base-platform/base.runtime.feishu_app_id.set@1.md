# base.runtime.feishu_app_id.set@1

Changes the Feishu application identifier and reloads settings.

## 使用判断

- 适用：Changes the Feishu application identifier and reloads settings.
...
```json
{
  "capability_id": "base.runtime.feishu_app_id.set",
