# base.authorization.grant.change.apply@1

Execute the reviewed base.authorization.grant.change.apply Base outcome.

## 使用判断

- 适用：Execute the reviewed base.authorization.grant.change.apply Base outcome.
...
```json
{
  "capability_id": "base.authorization.grant.change.apply",
