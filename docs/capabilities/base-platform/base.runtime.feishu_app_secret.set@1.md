# base.runtime.feishu_app_secret.set@1

Replaces the Feishu application secret without returning it.

## 使用判断

- 适用：Replaces the Feishu application secret without returning it.
...
```json
{
  "capability_id": "base.runtime.feishu_app_secret.set",
