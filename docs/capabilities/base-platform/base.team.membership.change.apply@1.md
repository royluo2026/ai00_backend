# base.team.membership.change.apply@1

Execute the reviewed base.team.membership.change.apply Base outcome.

## 使用判断

- 适用：Execute the reviewed base.team.membership.change.apply Base outcome.
...
```json
{
  "capability_id": "base.team.membership.change.apply",
