# base.runtime.feishu_app_id.get@1

Reads the configured Feishu application identifier.

## 使用判断

- 适用：Reads the configured Feishu application identifier.
...
```json
{
  "capability_id": "base.runtime.feishu_app_id.get",
