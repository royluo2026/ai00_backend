# base.runtime.feature_flags.get@1

Reads the current UI feature configuration without exposing other system configuration.

## 使用判断

- 适用：Reads the current UI feature configuration without exposing other system configuration.
...
```json
{
  "capability_id": "base.runtime.feature_flags.get",
