# base.artifact.text.get@1

Reads an owned bounded text artifact with verified hash and UTF-8 decoding.

## 使用判断

- 适用：Reads an owned bounded text artifact with verified hash and UTF-8 decoding.
...
```json
{
  "capability_id": "base.artifact.text.get",
