# base.identity.directory.sync@1

Execute the reviewed base.identity.directory.sync Base outcome.

## 使用判断

- 适用：Execute the reviewed base.identity.directory.sync Base outcome.
...
```json
{
  "capability_id": "base.identity.directory.sync",
