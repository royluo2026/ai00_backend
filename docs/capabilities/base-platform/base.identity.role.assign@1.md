# base.identity.role.assign@1

Execute the reviewed base.identity.role.assign Base outcome.

## 使用判断

- 适用：Execute the reviewed base.identity.role.assign Base outcome.
...
```json
{
  "capability_id": "base.identity.role.assign",
