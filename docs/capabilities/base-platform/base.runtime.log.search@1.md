# base.runtime.log.search@1

Reads at most 500 bounded runtime diagnostic messages.

## 使用判断

- 适用：Reads at most 500 bounded runtime diagnostic messages.
...
```json
{
  "capability_id": "base.runtime.log.search",
