# base.feishu.calendar.event.get@1

Reads the editable title and description of one event visible to the authenticated Feishu user.

## 使用判断

- 适用：Reads the editable title and description of one event visible to the authenticated Feishu user.
...
```json
{
  "capability_id": "base.feishu.calendar.event.get",
