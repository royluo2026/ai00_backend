# base.approval.request.search@1

Execute base.approval.request.search in the Base Approval service.

## 使用判断

- 适用：Execute base.approval.request.search in the Base Approval service.
