# base.runtime.capability_status.set@1

Saves one documentation status annotation without changing Capability lifecycle or approvals.

## 使用判断

- 适用：Saves one documentation status annotation without changing Capability lifecycle or approvals.
...
```json
{
  "capability_id": "base.runtime.capability_status.set",
