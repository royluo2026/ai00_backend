# base.workspace.template.publish@1

Execute base.workspace.template.publish in the Base collaboration service.

## 使用判断

- 适用：Execute base.workspace.template.publish in the Base collaboration service.
