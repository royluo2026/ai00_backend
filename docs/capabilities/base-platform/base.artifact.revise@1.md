# base.artifact.revise@1

Associates a newly selected immutable replacement after checking access to both revisions.

## 使用判断

- 适用：Associates a newly selected immutable replacement after checking access to both revisions.
...
```json
{
  "capability_id": "base.artifact.revise",
