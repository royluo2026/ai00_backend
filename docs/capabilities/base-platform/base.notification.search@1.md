# base.notification.search@1

Execute base.notification.search in the Base collaboration service.

## 使用判断

- 适用：Execute base.notification.search in the Base collaboration service.
...
- 授权策略：`base.v2:base.collaboration.read`
- 自动化等级：`A2`
- 数据分类：`confidential`
- Delegation：`scoped`
- 认证新鲜度：0 秒
...
```json
{
  "capability_id": "base.notification.search",
