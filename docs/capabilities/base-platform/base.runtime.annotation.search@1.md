# base.runtime.annotation.search@1

Reads bounded documentation notes and status annotations for one named collection.

## 使用判断

- 适用：Reads bounded documentation notes and status annotations for one named collection.
...
```json
{
  "capability_id": "base.runtime.annotation.search",
