# base.artifact.text.create@1

Creates a new immutable text artifact from the user document content.

## 使用判断

- 适用：Creates a new immutable text artifact from the user document content.
...
```json
{
  "capability_id": "base.artifact.text.create",
