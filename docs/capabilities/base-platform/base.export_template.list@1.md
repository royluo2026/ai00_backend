# base.export_template.list@1

Lists the authenticated user’s visible export templates with a bounded, closed editor configuration.

## 使用判断

- 适用：Lists the authenticated user’s visible export templates with a bounded, closed editor configuration.
...
```json
{
  "capability_id": "base.export_template.list",
