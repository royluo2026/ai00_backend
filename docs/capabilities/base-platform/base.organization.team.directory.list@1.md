# base.organization.team.directory.list@1

Execute exact Base outcome base.organization.team.directory.list.
...
```json
{
  "capability_id": "base.organization.team.directory.list",
