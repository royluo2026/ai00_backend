...
Creates one team under a parent the authenticated administrator controls.

## 使用判断

- 适用：Creates one team under a parent the authenticated administrator controls.
...
```json
{
  "capability_id": "base.team.create",
