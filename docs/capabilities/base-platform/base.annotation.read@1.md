# base.annotation.read@1

Execute the reviewed base.annotation.read Base outcome.

## 使用判断

- 适用：Execute the reviewed base.annotation.read Base outcome.
...
```json
{
  "capability_id": "base.annotation.read",
