# base.feishu.calendar.day.get@1

Reads at most 500 calendar events for the authenticated Feishu user on one day.

## 使用判断

- 适用：Reads at most 500 calendar events for the authenticated Feishu user on one day.
...
```json
{
  "capability_id": "base.feishu.calendar.day.get",
