# base.runtime.capability_note.set@1

Saves one capability documentation note without changing governance decisions.

## 使用判断

- 适用：Saves one capability documentation note without changing governance decisions.
...
```json
{
  "capability_id": "base.runtime.capability_note.set",
