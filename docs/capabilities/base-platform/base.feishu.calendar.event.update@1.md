# base.feishu.calendar.event.update@1

Changes one Feishu event title or description under the user delegated organizer permission.

## 使用判断

- 适用：Changes one Feishu event title or description under the user delegated organizer permission.
...
```json
{
  "capability_id": "base.feishu.calendar.event.update",
