# base.feishu.document.search@1

Finds bounded matching Feishu documents available to the authenticated user.

## 使用判断

- 适用：Finds bounded matching Feishu documents available to the authenticated user.
...
```json
{
  "capability_id": "base.feishu.document.search",
