# base.feishu.user.search@1

Finds bounded Feishu contacts available to the authenticated user.

## 使用判断

- 适用：Finds bounded Feishu contacts available to the authenticated user.
...
```json
{
  "capability_id": "base.feishu.user.search",
