# base.file_store.public_config.get@1

Read the secret-filtered public file-store runtime configuration.

## 使用判断

- 适用：An authenticated web client needs file-store feature availability or administrator-safe display values.
