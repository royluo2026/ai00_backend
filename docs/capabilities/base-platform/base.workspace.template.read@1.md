# base.workspace.template.read@1

Execute base.workspace.template.read in the Base collaboration service.

## 使用判断

- 适用：Execute base.workspace.template.read in the Base collaboration service.
