# base.self_annotation.record.get@1

Execute exact Base outcome base.self_annotation.record.get.
...
- `invalid_input`：base.self_annotation.record.get can return invalid_input.（retryable=false）
