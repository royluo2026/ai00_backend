# base.feishu.calendar.rsvp.set@1

Sets the authenticated user RSVP for one Feishu event.

## 使用判断

- 适用：Sets the authenticated user RSVP for one Feishu event.
...
```json
{
  "capability_id": "base.feishu.calendar.rsvp.set",
