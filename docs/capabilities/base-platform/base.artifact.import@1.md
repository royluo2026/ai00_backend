# base.artifact.import@1

Adopts one finalized artifact selected and uploaded by Main, preserving its immutable hash, size and MIME.

## 使用判断

- 适用：Adopts one finalized artifact selected and uploaded by Main, preserving its immutable hash, size and MIME.
...
```json
{
  "capability_id": "base.artifact.import",
