# base.approval.request.get@1

Execute base.approval.request.get in the Base Approval service.

## 使用判断

- 适用：Execute base.approval.request.get in the Base Approval service.
...
- 授权策略：`base.v2:base.approval.read`
- 自动化等级：`A2`
- 数据分类：`confidential`
- Delegation：`scoped`
- 认证新鲜度：0 秒
...
```json
{
  "capability_id": "base.approval.request.get",
