# base.artifact.batch.import@1

Adopts up to 20 finalized artifacts selected and uploaded by Main under the authenticated owner.

## 使用判断

- 适用：Adopts up to 20 finalized artifacts selected and uploaded by Main under the authenticated owner.
...
```json
{
  "capability_id": "base.artifact.batch.import",
