...
def test_check_probes_split_governance_controller_and_relative_css(monkeypatch):
    bodies = {
        "/health": '"status"',
        "/ready": '"status"',
        "/": "AI00",
        ...
        "/web/admin/capability_governance/governance_api.js": "CapabilityGovernanceApi",
        "/web/admin/capability_governance/governance_controller.js": "CapabilityGovernanceController",
        "/web/admin/capability_governance/governance_controller_next.js": "CapabilityGovernanceControllerNext",
        "/web/admin/capability_governance/governance.css": ".governance-shell",
    }
    ...
    report = deployment.check("http://example.test")
    assert report["status"] == "passed"
    assert "/web/admin/capability_governance/governance_controller_next.js" in {row["path"] for row in report["checks"]}
    assert "/web/admin/capability_governance/governance.css" in {row["path"] for row in report["checks"]}
