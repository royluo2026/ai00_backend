...
from plugins.knowledge.knowledge_backend.contracts import PROPOSAL_SCHEMA, proposal_ref
...
def review_proposal(payload: dict[str, Any], context) -> dict[str, Any]:
    ...
    from plugins.knowledge.knowledge_backend.capabilities.outbox_retry_next import retry_publish
