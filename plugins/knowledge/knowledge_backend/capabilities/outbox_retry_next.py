...
from plugins.knowledge.knowledge_backend.contracts import OUTBOX_SCHEMA, entry_ref, outbox_ref
...
from plugins.knowledge.knowledge_backend.storage import publish_proposal_markdown
