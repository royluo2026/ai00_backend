...
from .ontology_proposals_next import CHANGE_SCHEMA, PROPOSAL_SCHEMA, create_proposal
...
def register_reviewed_capabilities(registry):
    for capability_id in IDS:
        ...
        registry.register(CapabilitySpec(
            id=capability_id, version=2, owner="ontology",
            description="Convert a structured schema or mapping change into a governed Ontology proposal.",
            use_when="A consumer needs to propose a structured Ontology change.",
            do_not_use_when="The caller expects direct mutable schema CRUD.",
            risk=CapabilityRisk.WRITE, confirmation="user", permissions=("ontology.propose",), plugin_callable=True,
