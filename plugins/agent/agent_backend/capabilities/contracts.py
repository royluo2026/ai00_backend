...
OUTPUT_SCHEMAS.update({
    ...
    "agent.orchestration.version.publish": obj({"version_gid": STRING, "status": STRING}, required=("version_gid", "status")),
    ...
    "agent.orchestration.run.transition": obj({"status": STRING, "event_gid": STRING, "run_gid": STRING}, required=("status", "event_gid", "run_gid")),
