...
class BopRepositoryStore(Protocol):
    def search_repositories(self, **kwargs: Any) -> dict[str, Any]: ...
    def get_repository(self, **kwargs: Any) -> dict[str, Any]: ...
    def create_repository(self, **kwargs: Any) -> dict[str, Any]: ...
    def archive_repository(self, **kwargs: Any) -> dict[str, Any]: ...
    def restore_repository(self, **kwargs: Any) -> dict[str, Any]: ...
    def delete_repository(self, **kwargs: Any) -> dict[str, Any]: ...
    def search_spaces(self, **kwargs: Any) -> dict[str, Any]: ...
    def create_personal_space(self, **kwargs: Any) -> dict[str, Any]: ...
    def get_space(self, space_gid: str, **kwargs: Any) -> dict[str, Any]: ...
    def search_space_versions(self, **kwargs: Any) -> dict[str, Any]: ...
    def get_space_version(self, **kwargs: Any) -> dict[str, Any]: ...
