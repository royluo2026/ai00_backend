...
OUTPUT_SCHEMAS[("craft.standard_operation.read", 1)] = _object({
    "items": {"type": "array", "maxItems": 500, "items": _object({
        ...
        "component_type": {"type": "string"}, "bom_row": {"type": "string"}, "parent_bom_row": {"type": "string"},
        "level": {"type": "string"},
        "ai00_level": {"type": ["integer", "null"]},
        ...
        "process_vpps": {"type": "string"}, "operation_vpps": {"type": "string"},
        "vpps_part": {"type": "string"}, "match_tag": {"type": "string"}, "part_feed": BOOLEAN,
    ...
    "importance": {"type": "string"}, "description": {"type": "string"},
    "component_type": {"type": "string"}, "bom_row": {"type": "string"}, "parent_bom_row": {"type": "string"},
    "level": {"type": "string"}, "ai00_level": {"type": ["integer", "null"]},
    "vpps_attr": {"type": "string"}, "vpps": {"type": ["string", "null"]},
    "vpps_desc": {"type": "string"}, "torque_importance": {"type": "string"},
    "vehicle_model": {"type": "string"}, "parent_vpps": {"type": "string"},
    "process_vpps": {"type": "string"}, "operation_vpps": {"type": "string"},
...
INPUT_SCHEMAS[("craft.bop.entry.legacy_read", 1)] = _object({"operation": {"type": "string", "enum": ["auto_link_preview", "entry_links", "link_summary", "entity_detail", "resolve_gids", "pbom_search", "pbom_snapshots", "project_bop_lines", "line_operations", "version_history", "entry_history", "version_entries"]}, "version_gid": {"type": "string"}, "entry_gid": {"type": "string"}, "line_entry_gid": {"type": "string"}, "link_type": {"type": "string"}, "ref_gid": {"type": "string"}, "gids": {"type": "object", "additionalProperties": {"type": "string"}}, "recursive": {"type": "boolean"}, "q": {"type": ["string", "null"]}, "vpps": {"type": ["string", "null"]}, "snapshot_gid": {"type": ["string", "null"]}, "project_gid": {"type": ["string", "null"]}, "limit": {"type": "integer", "minimum": 1, "maximum": 500}, "offset": {"type": "integer", "minimum": 0}}, required=("operation",))
OUTPUT_SCHEMAS[("craft.bop.entry.legacy_read", 1)] = _object({"ok": {"type": "boolean"}, "data": {"type": ["array", "object"], "additionalProperties": True}, "items": {"type": "array", "maxItems": 100, "items": {"type": "object", "additionalProperties": True}}, "total": {"type": "integer"}, "limit": {"type": "integer"}, "offset": {"type": "integer"}}, required=("data",))
